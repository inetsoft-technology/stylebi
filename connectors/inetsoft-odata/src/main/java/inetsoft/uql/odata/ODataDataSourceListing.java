...
public class ODataDataSourceListing extends DataSourceListing {
   public ODataDataSourceListing() {
      super("OData", "REST", "/inetsoft/uql/odata/odata.svg");
   }

   @Override
   public XDataSource createDataSource() throws RemoteException {
      ODataDataSource dataSource = new ODataDataSource();
