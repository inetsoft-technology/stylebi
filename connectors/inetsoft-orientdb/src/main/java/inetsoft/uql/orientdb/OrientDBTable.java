...
/**
 * Class that represents a result set from a OrientDB server
 */
public class OrientDBTable extends XTableNode {

   /**
    * Constructor
    *
    * @param result ResultSet from the OrientDB JDBC driver
    * @throws SQLException
    */
   public OrientDBTable(ResultSet result) throws Exception{
   ...
   private static final Logger LOG = LoggerFactory.getLogger(OrientDBTable.class.getName());
}
