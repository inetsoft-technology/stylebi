/*
 * jdbc-derby - StyleBI is a business intelligence web application.
 ...
 */
package com.inetsoft.jdbc.derby;
...
public class DriverService extends AbstractDriverService {
   ...
   private final Set<String> drivers = Collections.singleton("org.apache.derby.jdbc.EmbeddedDriver");
