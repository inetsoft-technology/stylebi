...
public class GoogleSearchConsoleQuery extends EndpointJsonQuery<GoogleSearchConsoleEndpoint> {
   public GoogleSearchConsoleQuery() {
      super(GoogleSearchConsoleDataSource.TYPE);
      setJsonPath("$");
   }

   @Override
   public String getURL() {
      if(getEndpoint().equals("URL Inspection")) {
   ...
   @Override
   protected void updatePagination(GoogleSearchConsoleEndpoint endpoint) {
   ...
   @Override
   public Map<String, GoogleSearchConsoleEndpoint> getEndpointMap() {
      if("true".equals(SreeEnv.getProperty("debug.endpoints"))) {
         return Endpoints.load(GoogleSearchConsoleEndpoints.class);
      }
   ...
   enum Singleton {
      INSTANCE;
      private final Map<String, GoogleSearchConsoleEndpoint> endpoints =
         Endpoints.load(GoogleSearchConsoleEndpoints.class);
    }
