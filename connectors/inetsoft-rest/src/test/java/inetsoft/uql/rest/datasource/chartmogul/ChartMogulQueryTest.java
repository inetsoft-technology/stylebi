...
@SreeHome
class ChartMogulQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ChartMogulDataSource.class, query = ChartMogulQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ChartMogulQuery query) {
