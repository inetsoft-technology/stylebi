...
@SreeHome
class YouTubeAnalyticsQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = YouTubeAnalyticsDataSource.class, query = YouTubeAnalyticsQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, YouTubeAnalyticsQuery query) {
