...
@SreeHome
class SendGridQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = SendGridDataSource.class, query = SendGridQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, SendGridQuery query) {
