...
@SreeHome
class ChargifyQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ChargifyDataSource.class, query = ChargifyQuery.class)
   @Tag("endpoints")
   @Timeout(30)
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ChargifyQuery query) {
