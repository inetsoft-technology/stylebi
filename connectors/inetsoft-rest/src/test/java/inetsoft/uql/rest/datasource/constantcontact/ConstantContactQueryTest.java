...
class ConstantContactQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ConstantContactDataSource.class, query = ConstantContactQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ConstantContactQuery query) {
