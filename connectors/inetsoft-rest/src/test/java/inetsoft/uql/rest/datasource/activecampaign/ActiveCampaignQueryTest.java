...
@SreeHome
class ActiveCampaignQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ActiveCampaignDataSource.class, query = ActiveCampaignQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ActiveCampaignQuery query) {
