...
@SreeHome
class StripeQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = StripeDataSource.class, query = StripeQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, StripeQuery query) {
