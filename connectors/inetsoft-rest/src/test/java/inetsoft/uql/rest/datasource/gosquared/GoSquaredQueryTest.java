...
@SreeHome
class GoSquaredQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = GoSquaredDataSource.class, query = GoSquaredQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, GoSquaredQuery query) {
