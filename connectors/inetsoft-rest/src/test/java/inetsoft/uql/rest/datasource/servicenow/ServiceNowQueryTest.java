...
@SreeHome
class ServiceNowQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ServiceNowDataSource.class, query = ServiceNowQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ServiceNowQuery query) {
