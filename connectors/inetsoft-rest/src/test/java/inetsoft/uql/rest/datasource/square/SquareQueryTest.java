...
@SreeHome
class SquareQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = SquareDataSource.class, query = SquareQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, SquareQuery query) {
