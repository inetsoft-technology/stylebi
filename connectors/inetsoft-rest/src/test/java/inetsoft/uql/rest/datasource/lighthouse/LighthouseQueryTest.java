...
@SreeHome
class LighthouseQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = LighthouseDataSource.class, query = LighthouseQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, LighthouseQuery query) {
