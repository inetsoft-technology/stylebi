...
@SreeHome
class ZendeskQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ZendeskDataSource.class, query = ZendeskQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ZendeskQuery query) {
