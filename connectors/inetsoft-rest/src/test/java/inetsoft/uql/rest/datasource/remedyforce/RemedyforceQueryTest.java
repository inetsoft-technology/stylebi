...
@SreeHome
class RemedyforceQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = RemedyforceDataSource.class, query = RemedyforceQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, RemedyforceQuery query) {
