...
class JiveQueryTest {
   ...
   @EndpointsSource(dataSource = JiveDataSource.class, query = JiveQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, JiveQuery query) {
      // service is really slow, max out at 2 pages
      query.setMaxRows(50);
