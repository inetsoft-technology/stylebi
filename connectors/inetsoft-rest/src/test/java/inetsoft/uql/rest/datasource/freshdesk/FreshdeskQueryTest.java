...
@SreeHome
class FreshdeskQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = FreshdeskDataSource.class, query = FreshdeskQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, FreshdeskQuery query) {
