...
@SreeHome
class ChargebeeQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ChargebeeDataSource.class, query = ChargebeeQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ChargebeeQuery query) {
