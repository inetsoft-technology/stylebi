...
@SreeHome
class TogglQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = TogglDataSource.class, query = TogglQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, TogglQuery query) {
