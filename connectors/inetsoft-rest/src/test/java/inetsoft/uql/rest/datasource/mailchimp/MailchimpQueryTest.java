...
@SreeHome
class MailchimpQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = MailchimpDataSource.class, query = MailchimpQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, MailchimpQuery query) {
