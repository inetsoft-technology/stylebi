...
@SreeHome
class LiveAgentQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = LiveAgentDataSource.class, query = LiveAgentQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, LiveAgentQuery query) {
