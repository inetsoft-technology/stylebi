...
@SreeHome
class SEOmonitorQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = SEOmonitorDataSource.class, query = SEOmonitorQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, SEOmonitorQuery query) {
