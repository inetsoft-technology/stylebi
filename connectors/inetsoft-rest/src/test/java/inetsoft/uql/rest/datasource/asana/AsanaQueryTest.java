...
@SreeHome
class AsanaQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = AsanaDataSource.class, query = AsanaQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, AsanaQuery query) {
