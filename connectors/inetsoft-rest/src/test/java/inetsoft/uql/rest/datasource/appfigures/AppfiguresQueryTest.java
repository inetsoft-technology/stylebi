...
@SreeHome
class AppfiguresQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = AppfiguresDataSource.class, query = AppfiguresQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, AppfiguresQuery query) {
