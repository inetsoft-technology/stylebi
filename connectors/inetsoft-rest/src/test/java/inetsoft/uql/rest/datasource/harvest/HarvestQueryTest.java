...
@SreeHome
class HarvestQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = HarvestDataSource.class, query = HarvestQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, HarvestQuery query) {
