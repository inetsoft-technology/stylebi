...
@SreeHome
class AzureBlobQueryTest {

//   @ParameterizedTest(name = "{0}")
//   @EndpointsSource(dataSource = AzureBlobDataSource.class, query = AzureBlobQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, AzureBlobQuery query) {
