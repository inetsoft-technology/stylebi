...
class PrometheusQueryTest {
   ...
   @EndpointsSource(dataSource = PrometheusDataSource.class, query = PrometheusQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, PrometheusQuery query) {
