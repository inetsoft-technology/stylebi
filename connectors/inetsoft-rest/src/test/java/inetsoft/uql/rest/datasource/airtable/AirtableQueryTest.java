...
@SreeHome
class AirtableQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = AirtableDataSource.class, query = AirtableQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, AirtableQuery query) {
