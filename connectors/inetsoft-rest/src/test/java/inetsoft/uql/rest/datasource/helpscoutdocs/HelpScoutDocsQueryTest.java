...
@SreeHome
class HelpScoutDocsQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = HelpScoutDocsDataSource.class, query = HelpScoutDocsQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, HelpScoutDocsQuery query) {
