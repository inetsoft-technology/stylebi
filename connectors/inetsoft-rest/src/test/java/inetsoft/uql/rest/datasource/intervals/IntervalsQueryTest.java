...
@SreeHome
class IntervalsQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = IntervalsDataSource.class, query = IntervalsQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, IntervalsQuery query) {
