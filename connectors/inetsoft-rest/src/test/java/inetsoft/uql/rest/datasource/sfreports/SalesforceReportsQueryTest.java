...
@SreeHome
class SalesforceReportsQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = SalesforceReportsDataSource.class, query = SalesforceReportsQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, SalesforceReportsQuery query) {
