...
@SreeHome
class PipelineCRMQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = PipelineCRMDataSource.class, query = PipelineCRMQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, PipelineCRMQuery query) {
