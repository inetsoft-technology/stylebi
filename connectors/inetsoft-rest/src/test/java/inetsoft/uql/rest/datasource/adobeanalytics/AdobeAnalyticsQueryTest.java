...
@SreeHome
class AdobeAnalyticsQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = AdobeAnalyticsDataSource.class, query = AdobeAnalyticsQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, AdobeAnalyticsQuery query) {
