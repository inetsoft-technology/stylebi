...
class LinkedinQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = LinkedinDataSource.class, query = LinkedinQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, LinkedinQuery query) {
