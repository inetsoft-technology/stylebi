...
@SreeHome
class PipedriveQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = PipedriveDataSource.class, query = PipedriveQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, PipedriveQuery query) {
