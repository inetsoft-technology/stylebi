...
@SreeHome
class DataDotWorldQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = DataDotWorldDataSource.class, query = DataDotWorldQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, DataDotWorldQuery query) {
