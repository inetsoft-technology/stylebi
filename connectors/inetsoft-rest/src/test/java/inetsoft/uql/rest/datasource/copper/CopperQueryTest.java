...
@SreeHome
class CopperQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = CopperDataSource.class, query = CopperQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, CopperQuery query) {
