...
@SreeHome
class TeamDeskQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = TeamDeskDataSource.class, query = TeamDeskQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, TeamDeskQuery query) {
