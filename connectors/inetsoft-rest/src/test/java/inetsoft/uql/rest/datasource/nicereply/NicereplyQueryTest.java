...
@SreeHome
class NicereplyQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = NicereplyDataSource.class, query = NicereplyQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, NicereplyQuery query) {
