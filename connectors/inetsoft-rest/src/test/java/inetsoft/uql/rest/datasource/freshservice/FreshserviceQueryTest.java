...
@SreeHome
class FreshserviceQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = FreshserviceDataSource.class, query = FreshserviceQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, FreshserviceQuery query) {
