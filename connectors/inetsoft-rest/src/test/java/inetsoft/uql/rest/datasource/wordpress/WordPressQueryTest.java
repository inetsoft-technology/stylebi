...
class WordPressQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = WordPressDataSource.class, query = WordPressQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, WordPressQuery query) {
