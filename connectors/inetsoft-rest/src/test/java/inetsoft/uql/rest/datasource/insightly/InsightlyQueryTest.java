...
@SreeHome
class InsightlyQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = InsightlyDataSource.class, query = InsightlyQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, InsightlyQuery query) {
