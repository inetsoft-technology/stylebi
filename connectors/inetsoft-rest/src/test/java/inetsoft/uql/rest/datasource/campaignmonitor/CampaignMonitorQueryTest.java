...
@SreeHome
class CampaignMonitorQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = CampaignMonitorDataSource.class, query = CampaignMonitorQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, CampaignMonitorQuery query) {
