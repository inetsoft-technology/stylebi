...
@SreeHome
class FusebillQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = FusebillDataSource.class, query = FusebillQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, FusebillQuery query) {
