...
@SreeHome
class SmartsheetQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = SmartsheetDataSource.class, query = SmartsheetQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, SmartsheetQuery query) {
