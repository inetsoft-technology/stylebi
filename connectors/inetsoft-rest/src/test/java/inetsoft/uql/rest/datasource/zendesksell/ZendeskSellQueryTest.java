...
@SreeHome
class ZendeskSellQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = ZendeskSellDataSource.class, query = ZendeskSellQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, ZendeskSellQuery query) {
