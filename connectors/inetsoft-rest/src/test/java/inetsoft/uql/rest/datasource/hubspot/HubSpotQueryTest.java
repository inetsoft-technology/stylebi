...
@SreeHome
class HubSpotQueryTest {

   @ParameterizedTest(name = "{0}")
   @EndpointsSource(dataSource = HubSpotDataSource.class, query = HubSpotQuery.class)
   @Tag("endpoints")
   void testRunQuery(@SuppressWarnings("unused") String endpoint, HubSpotQuery query) {
