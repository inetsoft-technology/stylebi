...
/**
 * Class that represents a result set from a Aerospike server
 */
public class AerospikeTable extends XTableNode {

   /**
    * Constructor
    *
    * @param result ResultSet from the Aerospike JDBC driver
    * @throws SQLException
    */
   public AerospikeTable(ResultSet result) throws Exception{
   ...
   private static final Logger LOG = LoggerFactory.getLogger(AerospikeTable.class.getName());
}
