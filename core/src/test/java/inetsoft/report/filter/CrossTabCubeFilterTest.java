...
@SreeHome
public class CrossTabCubeFilterTest {
   @Test
   public void testSerialize() throws Exception {
      ...
      CrossTabCubeFilter originalTable = new CrossTabCubeFilter(XTableUtil.getDefaultTableLens(),
                                                                columnSelection, rowh, colh,
                                                                dcol, formulas, false);
      XTable deserializedTable = TestSerializeUtils.serializeAndDeserialize(originalTable);
      Assertions.assertEquals(CrossTabCubeFilter.class, deserializedTable.getClass());
   }
}
