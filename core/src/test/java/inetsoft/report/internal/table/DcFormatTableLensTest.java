...
@SreeHome
public class DcFormatTableLensTest {
   @Test
   public void testSerialize() throws Exception {
      ...
      DcFormatTableLens originalTable = new DcFormatTableLens(base, dcFormat);
      ...
      Assertions.assertEquals(DcFormatTableLens.class, deserializedTable.getClass());

      DcFormatTableLens deserializedTable2 = (DcFormatTableLens) deserializedTable;
