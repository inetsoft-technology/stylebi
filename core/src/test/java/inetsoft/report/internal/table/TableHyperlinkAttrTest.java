...
@SreeHome
public class TableHyperlinkAttrTest {
   @Test
   public void testSerializeHyperlinkTableLens() throws Exception {
      ...
      Assertions.assertEquals("inetsoft.report.internal.table.TableHyperlinkAttr$HyperlinkTableLens",
