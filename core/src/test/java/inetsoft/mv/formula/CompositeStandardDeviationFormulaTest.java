...
class CompositeStandardDeviationFormulaTest {

   private CompositeStandardDeviationFormula formula;

   @BeforeEach
   void setUp() {
      formula = new CompositeStandardDeviationFormula();
   }
   ...
   void testGetResult() {
      ...
      assertEquals(Math.sqrt(0.05555555555555555), ((Number) result).doubleValue());
      assertEquals(Math.sqrt(0.05555555555555555), formula.getDoubleResult());
   ...
   @Test
   void testClone() {
      CompositeStandardDeviationFormula clonedFormula = (CompositeStandardDeviationFormula) formula.clone();
