...
/**
 * MirrroVariableAssemblyInfo stores basic mirror variable assembly information.
 *
 * @version 8.0
 * @author InetSoft Technology Corp
 */
public class MirrorVariableAssemblyInfo extends WSAssemblyInfo
   implements MirrorAssemblyInfo
{
   /**
    * Constructor.
    */
   public MirrorVariableAssemblyInfo() {
      super();
   ...
   public Object clone() {
      try {
         MirrorVariableAssemblyInfo info =
            (MirrorVariableAssemblyInfo) super.clone();
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(MirrorVariableAssemblyInfo.class);
}
