...
/**
 * MirrroTableAssemblyInfo stores basic mirror table assembly information.
 *
 * @version 8.0
 * @author InetSoft Technology Corp
 */
public class MirrorTableAssemblyInfo extends ComposedTableAssemblyInfo
   implements MirrorAssemblyInfo
{
   /**
    * Constructor.
    */
   public MirrorTableAssemblyInfo() {
      super();
   ...
   public Object clone(boolean recursive) {
      try {
         MirrorTableAssemblyInfo info =
            (MirrorTableAssemblyInfo) super.clone(recursive);
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(MirrorTableAssemblyInfo.class);
}
