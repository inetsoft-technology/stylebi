...
/**
 * MirrroNamedGroupAssemblyInfo stores basic mirror named group assembly
 * information.
 *
 * @version 8.0
 * @author InetSoft Technology Corp
 */
public class MirrorNamedGroupAssemblyInfo extends WSAssemblyInfo
   implements MirrorAssemblyInfo
{
   /**
    * Constructor.
    */
   public MirrorNamedGroupAssemblyInfo() {
      super();
   ...
   public Object clone() {
      try {
         MirrorNamedGroupAssemblyInfo info =
            (MirrorNamedGroupAssemblyInfo) super.clone();
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(MirrorNamedGroupAssemblyInfo.class);
}
