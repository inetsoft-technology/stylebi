...
/**
 * MirrroConditionAssemblyInfo stores basic mirror condition assembly
 * information.
 *
 * @version 8.0
 * @author InetSoft Technology Corp
 */
public class MirrorConditionAssemblyInfo extends ConditionAssemblyInfo
   implements MirrorAssemblyInfo
{
   /**
    * Constructor.
    */
   public MirrorConditionAssemblyInfo() {
      super();
   ...
   public Object clone() {
      try {
         MirrorConditionAssemblyInfo info =
            (MirrorConditionAssemblyInfo) super.clone();
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(MirrorConditionAssemblyInfo.class);
}
