...
/**
 * XLongColumn, maintains the meta information and data of one long table
 * column.
 *
 * @version 9.1
 * @author InetSoft Technology Corp
 */
public final class XLongColumn extends AbstractTableColumn {
   /**
   ...
   /**
    * Create an instance of <tt>XLongColumn</tt>.
    * @param isize the specified initial size.
    * @param size the specified max size.
    */
   public XLongColumn(char isize, char size) {
      super();
