...
/**
 * XBILongColumn, maintains the meta information and data of one big integer
 * table column. One big integer value will be converted to one long value.
 * Note that this conversion can lose information.
 *
 * @version 9.1
 * @author InetSoft Technology Corp
 */
public final class XBILongColumn extends AbstractTableColumn {
   /**
   ...
   /**
    * Create an instance of <tt>XBILongColumn</tt>.
    * @param isize the specified initial size.
    * @param size the specified max size.
    */
   public XBILongColumn(char isize, char size) {
      super();
   ...
   public XTableColumn addObject(Object obj) {
      ensureCapacity();
      arr[pos++] = obj == null ? Tool.NULL_LONG : ((Number) obj).longValue();
   ...
   public Object getObject(int r) {
      long[] arr = access();
      return arr[r] == Tool.NULL_LONG ? null : arr[r];
   }
