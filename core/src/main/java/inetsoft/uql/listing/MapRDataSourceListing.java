...
public class MapRDataSourceListing extends DataSourceListing {
   public MapRDataSourceListing() {
      super("MapR", "Big Data", "/inetsoft/uql/listing/mapr.svg");
   }
   ...
   public XDataSource createDataSource() throws Exception {
      ...
      ds.setURL("jdbc:hive2://<host>:<port>/");
