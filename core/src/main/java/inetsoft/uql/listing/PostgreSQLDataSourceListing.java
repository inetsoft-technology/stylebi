...
public class PostgreSQLDataSourceListing extends DataSourceListing {
   public PostgreSQLDataSourceListing() {
      super("PostgreSQL", "Relational Database", "/inetsoft/uql/listing/postgresql.svg");
   }
