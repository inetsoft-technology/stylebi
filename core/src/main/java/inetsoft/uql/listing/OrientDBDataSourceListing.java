...
public class OrientDBDataSourceListing extends DataSourceListing {
   public OrientDBDataSourceListing() {
      super("OrientDB", "NoSQL", "/inetsoft/uql/listing/orientdb.svg");
   }
   ...
   public XDataSource createDataSource() throws Exception {
      ...
      ds.setURL("jdbc:orient:remote:localhost/<databaseName>");
      ds.setDriver("com.orientechnologies.orient.jdbc.OrientJdbcDriver");
