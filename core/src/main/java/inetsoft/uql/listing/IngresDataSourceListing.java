...
public class IngresDataSourceListing extends DataSourceListing {
   public IngresDataSourceListing() {
      super("Ingres", "Relational Database", "/inetsoft/uql/listing/ingres.svg");
   }
