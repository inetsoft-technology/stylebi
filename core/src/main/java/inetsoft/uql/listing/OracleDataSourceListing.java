...
public class OracleDataSourceListing extends DataSourceListing {
   public OracleDataSourceListing() {
      super("Oracle", "Relational Database", "/inetsoft/uql/listing/oracle.svg");
   }
