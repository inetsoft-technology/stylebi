...
public class GoogleBigQueryDataSourceListing extends DataSourceListing {
   public GoogleBigQueryDataSourceListing() {
      super("Google BigQuery", "Big Data", "/inetsoft/uql/listing/google-bigquery.svg");
   }
