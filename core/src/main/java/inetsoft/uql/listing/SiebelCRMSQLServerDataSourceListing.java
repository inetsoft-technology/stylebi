...
public class SiebelCRMSQLServerDataSourceListing extends DataSourceListing {
   public SiebelCRMSQLServerDataSourceListing() {
      super("Siebel CRM (SQL Server)", "Sales", "/inetsoft/uql/listing/oracle-siebel.svg");
   }
