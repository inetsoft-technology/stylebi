...
public class SiebelCRMOracleDataSourceListing extends DataSourceListing {
   public SiebelCRMOracleDataSourceListing() {
      super("Siebel CRM (Oracle)", "Sales", "/inetsoft/uql/listing/oracle-siebel.svg");
   }
