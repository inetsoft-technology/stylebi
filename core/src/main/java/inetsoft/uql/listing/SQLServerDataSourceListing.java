...
public class SQLServerDataSourceListing extends DataSourceListing {
   public SQLServerDataSourceListing() {
      super("SQL Server", "Relational Database", "/inetsoft/uql/listing/microsoft-sql-server.svg");
   }
