...
public class AmazonAuroraMySQLDataSourceListing extends DataSourceListing {
   public AmazonAuroraMySQLDataSourceListing() {
      super(
         "Amazon Aurora/RDS MySQL", "Relational Database", "/inetsoft/uql/listing/aws-mysql.svg");
   }
