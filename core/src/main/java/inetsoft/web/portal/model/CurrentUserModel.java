...
@Value.Immutable
@JsonSerialize(as = ImmutableCurrentUserModel.class)
@JsonDeserialize(as = ImmutableCurrentUserModel.class)
public abstract class CurrentUserModel {
   ...
   public static final class Builder extends ImmutableCurrentUserModel.Builder {
   }
}
