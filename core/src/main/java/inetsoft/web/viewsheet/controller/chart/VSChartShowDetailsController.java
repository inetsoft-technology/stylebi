...
public class VSChartShowDetailsController extends VSChartController<VSChartShowDetailsEvent> {
    ...
    * @return table lens
    */
   public FormatTableLens2 getShowDetailDatas(VSChartShowDetailsEvent event,  RuntimeViewsheet rvs, String assemblyName,
    ...
    * @return table lens
    */
   private FormatTableLens2 applyChanges(RuntimeViewsheet rvs,
                                         ChartVSAssembly chartVSAssembly,
                                         ...
                                         CommandDispatcher dispatcher) throws Exception
   {
      ...
      // Removed grid, this is logic from old showDetailEvent, should be updated/removed
//      if(chartVSAssembly.getColumnWidths() != null) {
//         String[] widths = Tool.split(chartVSAssembly.getColumnWidths(), ",");
//
...
//      }
      ...
      if(infos != null) {
         BaseTableShowDetailsController.updateColumnHeaders(tableLens, infos,
      ...
      if(event.getDndInfo() != null) {
         ...
         infos = cols;
         tableLens = BaseTableShowDetailsController.createColumnMapFilter(tableLens, cols, columns);
      }
         ...
         if(isChanged) {
            ...
            tableLens = BaseTableShowDetailsController.createColumnMapFilter(
