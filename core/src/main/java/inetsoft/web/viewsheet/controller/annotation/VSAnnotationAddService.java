...
@Service
@ClusterProxy
public class VSAnnotationAddService {

   public VSAnnotationAddService(VSObjectService service,
   ...
   public Void addAnnotation(@ClusterProxyKey String id, final AddAnnotationEvent event,
                             ...
                             final CommandDispatcher dispatcher, final int assemblyType) throws Exception
   {
