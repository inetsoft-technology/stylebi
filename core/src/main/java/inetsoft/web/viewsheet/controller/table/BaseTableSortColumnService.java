...
@Service
@ClusterProxy
public class BaseTableSortColumnService extends BaseTableService<SortColumnEvent> {
   public BaseTableSortColumnService(CoreLifecycleService coreLifecycleService,
