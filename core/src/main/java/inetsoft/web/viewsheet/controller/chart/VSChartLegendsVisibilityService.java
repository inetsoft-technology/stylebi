...
@Service
@ClusterProxy
public class VSChartLegendsVisibilityService extends VSChartControllerService<VSChartLegendsVisibilityEvent> {
   public VSChartLegendsVisibilityService(CoreLifecycleService coreLifecycleService,
