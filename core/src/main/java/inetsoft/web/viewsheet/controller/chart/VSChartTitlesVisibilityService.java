...
@Service
@ClusterProxy
public class VSChartTitlesVisibilityService extends VSChartControllerService<VSChartTitlesVisibilityEvent>
{
   public VSChartTitlesVisibilityService(CoreLifecycleService coreLifecycleService,
