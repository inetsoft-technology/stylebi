...
@Service
@ClusterProxy
public class BaseTableShowDetailsService extends BaseTableService<ShowDetailsEvent> {
   public BaseTableShowDetailsService(CoreLifecycleService coreLifecycleService,
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public FormatInfoModel getFormatModel(@ClusterProxyKey String runtimeId,
                                         ShowDetailsEvent event,
                                         Principal principal)
      throws Exception
   {
      ...
      throws Exception
   {
      ...
      if(infos != null) {
         updateColumnHeaders(tableLens, infos, columns);
      }
      ...
      if(event.dndInfo() != null) {
         ...
         if(isColumnChanged(infos, columns)) {
            ...
            assembly.setData(tableLens);
            updateColumnVisibility(infos, assembly.getColumnSelection());
         }
      }
