...
@Service
@ClusterProxy
public class VSChartSortAxisService extends VSChartControllerService<VSChartSortAxisEvent>{

   public VSChartSortAxisService(CoreLifecycleService coreLifecycleService,
