...
@Service
@ClusterProxy
public class VSDataTipService {

   public VSDataTipService(CoreLifecycleService coreLifecycleService,
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public DataTipDependencyCheckResult checkDataTipDependency(@ClusterProxyKey String runtimeId,
                                                              String assemblyName, String tipView,
   ...
   /**
    * Checks for DataTip View cycle dependency.
    **/
