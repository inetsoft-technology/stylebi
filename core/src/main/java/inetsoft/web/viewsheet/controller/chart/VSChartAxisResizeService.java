...
@Service
@ClusterProxy
public class VSChartAxisResizeService  extends VSChartControllerService<VSChartAxisResizeEvent> {
   public VSChartAxisResizeService(CoreLifecycleService coreLifecycleService,
