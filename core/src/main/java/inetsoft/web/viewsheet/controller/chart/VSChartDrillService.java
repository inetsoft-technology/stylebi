...
@Service
@ClusterProxy
public class VSChartDrillService extends VSChartControllerService<VSChartDrillEvent> {
   public VSChartDrillService(CoreLifecycleService coreLifecycleService,
