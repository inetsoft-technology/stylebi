...
@Service
@ClusterProxy
public class VSRefreshService {

   public VSRefreshService(CoreLifecycleService coreLifecycleService,
   ...
   public Void refreshVsAssembly(@ClusterProxyKey String runtimeId, RefreshVSAssemblyEvent event, CommandDispatcher dispatcher,
