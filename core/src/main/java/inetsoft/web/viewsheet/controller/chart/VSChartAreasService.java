...
@Service
@ClusterProxy
public class VSChartAreasService {

   public VSChartAreasService(ViewsheetService viewsheetService) {
   ...
   private static final Logger LOG = LoggerFactory.getLogger(VSChartAreasService.class);
