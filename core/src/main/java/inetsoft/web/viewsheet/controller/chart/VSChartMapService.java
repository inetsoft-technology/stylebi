...
@Service
@ClusterProxy
public class VSChartMapService {
   public VSChartMapService(CoreLifecycleService coreLifecycleService,
   ...
   private static final Logger LOG = LoggerFactory.getLogger(VSChartMapService.class);
}
