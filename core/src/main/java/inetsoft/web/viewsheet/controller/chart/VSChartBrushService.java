...
@Service
@ClusterProxy
public class VSChartBrushService extends VSChartControllerService<VSChartBrushEvent> {
   public VSChartBrushService(CoreLifecycleService coreLifecycleService,
   ...
   private void brush(VSChartBrushEvent event, VSChartStateInfo chartState,
   ...
   private static final Logger LOG = LoggerFactory.getLogger(VSChartBrushService.class);
}
