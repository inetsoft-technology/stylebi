 ...
 */
@Controller
public class BaseTableFlyoverController {
   @Autowired
   public BaseTableFlyoverController(RuntimeViewsheetRef runtimeViewsheetRef,
                                     BaseTableFlyoverServiceProxy baseTableFlyoverService)
   {
      this.runtimeViewsheetRef = runtimeViewsheetRef;
      this.baseTableFlyoverService = baseTableFlyoverService;
   }
   ...
   public void eventHandler(@Payload FlyoverEvent event, Principal principal,
      ...
      throws Exception
   {
      baseTableFlyoverService.eventHandler(runtimeViewsheetRef.getRuntimeId(), event,
                                           principal, dispatcher, linkUri);
   }

   private final RuntimeViewsheetRef runtimeViewsheetRef;
   private final BaseTableFlyoverServiceProxy baseTableFlyoverService;
}
