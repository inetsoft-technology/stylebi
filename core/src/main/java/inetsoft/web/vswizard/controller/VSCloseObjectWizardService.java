...
@Service
@ClusterProxy
public class VSCloseObjectWizardService {

   public VSCloseObjectWizardService(SyncChartHandler syncChartHandler,
   ...
   private static final Logger LOGGER = LoggerFactory.getLogger(VSCloseObjectWizardService.class);
}
