...
@Service
@ClusterProxy
public class VSWizardBindingService {

   public VSWizardBindingService(VSTreeHandler treeHandler,
   ...
   public Void getBindingTree(@ClusterProxyKey String id, GetBindingTreeEvent event,
