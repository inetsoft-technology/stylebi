...
public class ContourMapChartFilter extends MapChartFilter {
   public ContourMapChartFilter(AssetEntry[] entries, VSChartInfo temp, ColumnSelection geos,
                         List<List<ChartRef>> hgroup, boolean autoOrder)
   {
      super(entries, temp, geos, hgroup, autoOrder);
   }
