...
public class SystemMemoryScalingMetric extends ScalingMetric {
   public SystemMemoryScalingMetric(boolean movingAverage, int capacity) {
   ...
   protected double calculate() {
      ...
      if(os instanceof com.sun.management.OperatingSystemMXBean bean) {
         ...
         return (double) (heap + nonHeap) / total;
      }
      else {
         return (double) heap / memory.getHeapMemoryUsage().getMax();
      }
   }
}
