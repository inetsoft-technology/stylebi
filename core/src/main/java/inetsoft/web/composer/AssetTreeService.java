...
public class AssetTreeService {
    ...
    */
   @Autowired
   public AssetTreeService(AssetRepository assetRepository, ViewsheetService viewsheetService) {
      ...
      throws Exception
   {
      return getNodes0(includeDatasources, includeColumns, includeWorksheets, includeViewsheets,
                       ...
                       reportRepositoryEnabled, readOnly, physical, event, principal,
                       readOnly || assetRepository.checkPermission(principal,
                           ResourceType.WORKSHEET, "*", EnumSet.of(ResourceAction.ACCESS)),
