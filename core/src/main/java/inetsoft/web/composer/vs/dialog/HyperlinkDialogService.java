...
@Service
@ClusterProxy
public class HyperlinkDialogService {

   public HyperlinkDialogService(CoreLifecycleService coreLifecycleService,
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public VSTableTrapModel checkVSTableTrap(@ClusterProxyKey String runtimeId, HyperlinkDialogModel model,
   ...
   private List<DataRefModel> getFields(RuntimeViewsheet rvs, VSAssembly assembly,
