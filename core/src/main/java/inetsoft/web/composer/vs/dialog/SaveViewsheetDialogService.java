...
@Service
@ClusterProxy
public class SaveViewsheetDialogService {
   ...
   public SaveViewsheetDialogModel getSaveViewsheetInfo(@ClusterProxyKey String runtimeId, Principal principal) throws Exception
   {
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public SaveViewsheetDialogModelValidator validateSaveViewSheet(@ClusterProxyKey String runtimeId,
                                                                  SaveViewsheetDialogModel model,
