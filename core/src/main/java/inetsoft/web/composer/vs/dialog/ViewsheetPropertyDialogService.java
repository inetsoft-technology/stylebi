...
public class ViewsheetPropertyDialogService {
   ...
   public ViewsheetPropertyDialogModel getViewsheetInfo(@ClusterProxyKey String runtimeId,
                                                        Principal principal)
      throws Exception
   {
   ...
   public String setViewsheetInfo(@ClusterProxyKey String runtimeId, ViewsheetPropertyDialogModel value,
                                ...
                                String refLayoutName) throws Exception
   {
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public StringWrapper testVsScript(@ClusterProxyKey String runtimeId,
                                     ViewsheetPropertyDialogModel model, Principal principal)
      throws Exception
   {
      RuntimeViewsheet rvs = this.viewsheetService.getViewsheet(runtimeId, principal);
