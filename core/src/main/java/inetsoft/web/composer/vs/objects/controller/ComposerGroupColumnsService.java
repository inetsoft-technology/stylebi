...
@Service
@ClusterProxy
public class ComposerGroupColumnsService {

   public ComposerGroupColumnsService(ViewsheetService viewsheetService,
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public Boolean checkVSTableTrap(@ClusterProxyKey String runtimeId, GroupFieldsEvent event,
