...
@Service
@ClusterProxy
public class LinePropertyDialogService {

   public LinePropertyDialogService(VSObjectPropertyService vsObjectPropertyService,
   ...
   public LinePropertyDialogModel getLinePropertyDialogModel(@ClusterProxyKey String runtimeId,
