...
@Service
@ClusterProxy
public class SelectionContainerPropertyDialogService {

   public SelectionContainerPropertyDialogService(VSObjectPropertyService vsObjectPropertyService,
   ...
   public SelectionContainerPropertyDialogModel getSelectionContainerPropertyModel(@ClusterProxyKey String runtimeId,
