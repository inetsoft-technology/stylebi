...
@Service
@ClusterProxy
public class ComposerVSTableService {

   public ComposerVSTableService(CoreLifecycleService coreLifecycleService,
                             ...
                             CommandDispatcher dispatcher, String linkUri) throws Exception
   {
      ...
      if(table != null) {
         ...
         for(int i = cols.length - 1; i >= 0; i--) {
            int index = ComposerVSTableController.getActualColIndex(columns, cols[i]);
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(ComposerVSTableService.class);
}
