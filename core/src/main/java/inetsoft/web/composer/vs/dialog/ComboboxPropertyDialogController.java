...
public class ComboboxPropertyDialogController {
    ...
    */
   @Autowired
   public ComboboxPropertyDialogController(VSInputServiceProxy vsInputServiceProxy,
   ...
   public ComboboxPropertyDialogModel getComboboxPropertyDialogModel(
      ...
      throws Exception
   {
      return vsInputServiceProxy.getComboboxPropertyDialogModel(runtimeId, objectId, principal);
   }
   ...
   public void setComboboxPropertyDialogModel(@DestinationVariable("objectId") String objectId,
      ...
      throws Exception
   {
     vsInputServiceProxy.setComboboxPropertyDialogModel(runtimeViewsheetRef.getRuntimeId(), objectId,
   ...
   public ComboBoxDefaultValueListModel[] getComboBoxList(@RequestParam("runtimeId") String runtimeId,
                                                 ...
                                                 Principal principal)throws Exception
   {
      return vsInputServiceProxy.getComboBoxList(runtimeId, objectId, sortType, embeddedDataDown, model, principal);
   }
