...
public class VSLayoutControllerService {
      ...
      throws Exception
   {
      ...
      RuntimeViewsheet parentRvs = viewsheetService
         .getViewsheet(parentRuntimeId, principal);
      ...
      throws Exception
   {
      ...
      vsLayoutService.makeUndoable(
         parentRvs, dispatcher, focusedLayoutName);
      return null;
   }
      ...
      throws Exception
   {
      ...
      vsLayoutService.makeUndoable(rvs, commandDispatcher, focusedLayoutName);
      return null;
   }
   ...
   public TextPropertyDialogModel getTextPropertyDialogModel(
      ...
      int region, String layoutName, Principal principal)
      throws Exception
   {
      RuntimeViewsheet rvs = viewsheetService.getViewsheet(runtimeId, principal);
      ...
      throws Exception
   {
      ...
      assemblyLayout.ifPresent(l -> {
         ...
         commandDispatcher.sendCommand(command);
         vsLayoutService.makeUndoable(parentRvs, commandDispatcher, focusedLayoutName);
      });

      return assemblyLayout.isPresent();
   }

   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public ImagePropertyDialogModel getImagePropertyDialogModel(
      @ClusterProxyKey String runtimeId, int region, String layoutName, Principal principal)
      throws Exception
   {
      RuntimeViewsheet rvs = viewsheetService.getViewsheet(runtimeId, principal);
      RuntimeViewsheet parentRvs = rvs.getOriginalID() == null ? rvs :
   ...
   public Boolean setImagePropertyDialogModel(@ClusterProxyKey String runtimeId,
                                           ...
                                           int region,
                                           String layoutName,
                                           ImagePropertyDialogModel value,
                                           Principal principal,
                                           CommandDispatcher commandDispatcher)
      throws Exception
   {
   ...
   public Boolean setTableLayoutPropertyDialogModel(@ClusterProxyKey String runtimeId,
                                                    ...
                                                    int region,
                                                    String layoutName,
                                                    TableLayoutPropertyDialogModel model,
                                                    Principal principal,
                                                    CommandDispatcher commandDispatcher)
      throws Exception
   {
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public DataTipInLayoutCheckResult checkAssemblyInLayout(@ClusterProxyKey String runtimeId,
                                                           String layoutName,
                                                           String assemblyName,
                                                           Principal principal)
      throws Exception
