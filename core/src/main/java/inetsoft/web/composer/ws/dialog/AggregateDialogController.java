...
public class AggregateDialogController extends WorksheetController {
   ...
   public AggregateDialogController(AggregateDialogServiceProxy dialogServiceProxy)
   {
      ...
      Principal principal) throws Exception
   {
      ...
      return dialogServiceProxy.getModel(runtimeId, tname, principal);
   }
   ...
   {
      dialogServiceProxy.setAggregateInfo(getRuntimeId(), model, principal, commandDispatcher);
   }

   private final AggregateDialogServiceProxy dialogServiceProxy;
}