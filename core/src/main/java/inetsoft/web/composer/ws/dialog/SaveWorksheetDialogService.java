...
public class SaveWorksheetDialogService extends WorksheetControllerService {
   ...
   public SaveWorksheetDialogModel getSaveWorksheetInfo(@ClusterProxyKey String runtimeId, Principal principal) throws Exception
   {
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public SaveWorksheetDialogModelValidator validateSaveWorksheet(@ClusterProxyKey String runtimeId,
                                                                  SaveWorksheetDialogModel model,
