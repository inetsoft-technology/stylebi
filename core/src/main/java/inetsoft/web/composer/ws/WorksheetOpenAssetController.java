...
public class WorksheetOpenAssetController extends WorksheetController {
   ...
   public WorksheetOpenAssetController(WorksheetOpenAssetServiceProxy serviceProxy)
   {
      ...
      Principal principal) throws Exception
   {
      ...
      return serviceProxy.checkTrap(runtimeId, event, principal);
   }
   ...
   {
      serviceProxy.openAsset(getRuntimeId(), event, principal, commandDispatcher);
   }

   private WorksheetOpenAssetServiceProxy serviceProxy;
}
