...
public class VariableAssemblyDialogService extends WorksheetControllerService {
   ...
   public VariableAssemblyDialogModel getVariableAssemblyDialogModel(@ClusterProxyKey String runtimeId,
                                                                     String variableName, Principal principal) throws Exception
   {
