...
public class SelectionListPropertyDialogModel implements Serializable {
   ...
   public SelectionListPaneModel getSelectionListPaneModel() {
      if(selectionListPaneModel == null) {
         selectionListPaneModel = new SelectionListPaneModel();
      }
      return selectionListPaneModel;
   }

   public void setSelectionListPaneModel(SelectionListPaneModel selectionListpane) {
      this.selectionListPaneModel = selectionListpane;
   }
