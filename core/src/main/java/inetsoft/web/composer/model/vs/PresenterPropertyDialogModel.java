...
/**
 * Data transfer object that represents the {@link PresenterPropertyDialogModel} for the
...
public abstract class PresenterPropertyDialogModel {
   @Value.Default
   public List<PresenterDescriptorModel> descriptors() {
   ...
   public static class Builder extends ImmutablePresenterPropertyDialogModel.Builder {
   }
}