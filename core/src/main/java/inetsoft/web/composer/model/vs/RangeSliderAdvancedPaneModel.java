...
public class RangeSliderAdvancedPaneModel {
   public RangeSliderSizePaneModel getRangeSliderSizePaneModel() {
      ...
      return rangeSliderSizePaneModel;
   }

   public void setRangeSliderSizePaneModel(RangeSliderSizePaneModel rangeSliderSizePaneModel) {
      this.rangeSliderSizePaneModel = rangeSliderSizePaneModel;
   }
   ...
   private RangeSliderSizePaneModel rangeSliderSizePaneModel;
