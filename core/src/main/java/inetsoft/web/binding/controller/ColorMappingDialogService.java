...
@Service
@ClusterProxy
public class ColorMappingDialogService {
   public ColorMappingDialogService(
   ...
   private static final Logger LOG = LoggerFactory.getLogger(ColorMappingDialogService.class);
}
