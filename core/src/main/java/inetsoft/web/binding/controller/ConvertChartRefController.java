...
public class ConvertChartRefController {
   ...
   public ConvertChartRefController(
      ...
      ConvertChartRefServiceProxy convertChartRefService)
   {
      this.runtimeViewsheetRef = runtimeViewsheetRef;
      this.convertChartRefService = convertChartRefService;
   }
                               ...
                               @LinkUri String linkUri) throws Exception
   {
      ...
      convertChartRefService.convertChartRef(id, event, principal, dispatcher, linkUri);
   }

   private final RuntimeViewsheetRef runtimeViewsheetRef;
   private final ConvertChartRefServiceProxy convertChartRefService;
}
