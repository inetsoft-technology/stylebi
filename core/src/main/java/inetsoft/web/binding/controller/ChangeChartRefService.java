...
@Service
@ClusterProxy
public class ChangeChartRefService {
   public ChangeChartRefService(
      VSBindingService bindingFactory, CoreLifecycleService coreLifecycleService,
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(ChangeChartRefService.class);
}
