...
public class ChangeGeographicController {
   ...
   public ChangeGeographicController(
      ...
      ChangeGeographicServiceProxy changeGeographicService)
   {
      this.runtimeViewsheetRef = runtimeViewsheetRef;
      this.changeGeographicService = changeGeographicService;
   }
   ...
   public void changeGeographic(@Payload ChangeGeographicEvent event,
      ...
      changeGeographicService.changeGeographic(id, event, principal, dispatcher, linkUri);
   }

   private final RuntimeViewsheetRef runtimeViewsheetRef;
   private final ChangeGeographicServiceProxy changeGeographicService;
}
