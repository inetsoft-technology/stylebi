...
public class SwapXYBindingController {
   ...
   public SwapXYBindingController(
      ...
      SwapXYBindingServiceProxy swapXYBindingService)
   {
      this.runtimeViewsheetRef = runtimeViewsheetRef;
      this.swapXYBindingService = swapXYBindingService;
   }
                             ...
                             @LinkUri String linkUri) throws Exception
   {
      ...
      swapXYBindingService.swapXYBinding(id, event, principal, dispatcher, linkUri);
   }

   private final RuntimeViewsheetRef runtimeViewsheetRef;
   private final SwapXYBindingServiceProxy swapXYBindingService;
}
