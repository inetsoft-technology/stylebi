...
@Service
@ClusterProxy
public class VSDataService {

   public VSDataService(ChartRefModelFactoryService chartRefService, VSChartDataHandler chartDataHandler,
   ...
   public ValueLabelListModel getAvailableValues(@ClusterProxyKey String vsId, String assemblyName, Integer row,
                                                 Integer col, Integer dateLevel, GetAvailableValuesEvent event,
   ...
   @ClusterProxyMethod(WorksheetEngine.CACHE_NAME)
   public List<VariableAssemblyModelInfo> getRequiredVariables(@ClusterProxyKey String vsId, String assemblyName,
                                                               Principal principal) throws Exception
   {
      RuntimeViewsheet rvs = viewsheetService.getViewsheet(Tool.byteDecode(vsId), principal);
      Viewsheet viewsheet = rvs.getViewsheet();
