...
import inetsoft.uql.viewsheet.graph.aesthetic.LinearSizeFrameWrapper;

public class LinearSizeModel extends SizeFrameModel {
   public LinearSizeModel() {
   }

   public LinearSizeModel(LinearSizeFrameWrapper wrapper) {
      super(wrapper);
   }
