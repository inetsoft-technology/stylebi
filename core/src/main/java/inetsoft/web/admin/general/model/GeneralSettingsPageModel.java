...
@Value.Immutable
@JsonSerialize(as = ImmutableGeneralSettingsPageModel.class)
...
public interface GeneralSettingsPageModel {
   ...
   static GeneralSettingsPageModel.Builder builder() {
      return new GeneralSettingsPageModel.Builder();
   }

   final class Builder extends ImmutableGeneralSettingsPageModel.Builder {
   }
}
