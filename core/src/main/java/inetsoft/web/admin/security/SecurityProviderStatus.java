...
@Value.Immutable
@JsonSerialize(as = ImmutableSecurityProviderStatus.class)
...
public interface SecurityProviderStatus {
   ...
   final class Builder extends ImmutableSecurityProviderStatus.Builder {
      ...
      private void setCacheProperties(CachableProvider provider) {
         cacheEnabled(provider.isCacheEnabled());
         cacheAge(provider.getCacheAge());
