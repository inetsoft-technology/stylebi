...
@Value.Immutable
@JsonSerialize(as = ImmutableEditGroupPaneModel.class)
@JsonDeserialize(as = ImmutableEditGroupPaneModel.class)
...
public interface EditGroupPaneModel extends EntityModel {
   ...
   final class Builder extends ImmutableEditGroupPaneModel.Builder {
   }
}
