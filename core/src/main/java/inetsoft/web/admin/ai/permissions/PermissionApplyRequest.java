...
/** Request body for {@code POST /api/wiz/v1/admin/permissions/apply}: a plan request plus the
 * hash from {@code preview}. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class PermissionApplyRequest extends PermissionChangePlanRequest {
