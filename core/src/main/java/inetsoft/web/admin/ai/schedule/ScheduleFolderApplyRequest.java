...
/** Request body for {@code POST /api/wiz/v1/admin/schedule/folders/apply}: a plan request plus the
 * hash from {@code preview}. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ScheduleFolderApplyRequest extends ScheduleFolderChangePlanRequest {
