...
/** Request body for {@code POST /api/wiz/v1/admin/schedule/cycles/apply}: a plan request plus the
 * hash from {@code preview}. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ScheduleCycleApplyRequest extends ScheduleCycleChangePlanRequest {
