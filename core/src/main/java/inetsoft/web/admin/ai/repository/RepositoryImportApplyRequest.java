...
public class RepositoryImportApplyRequest extends RepositoryImportRequest {
   ...
   public boolean isAcknowledgeOverwrite() { return acknowledgeOverwrite; }
   public void setAcknowledgeOverwrite(boolean acknowledgeOverwrite) {
      this.acknowledgeOverwrite = acknowledgeOverwrite;
   }
}
