...
/** Request body for {@code POST /api/wiz/v1/admin/schedule/config/apply}: a plan request plus the
 * hash and taskToken from {@code preview}. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ScheduleConfigApplyRequest extends ScheduleConfigChangePlanRequest {
