 ...
 * {@code RecycleBinApplyOutcome}/{@code ScriptLibraryApplyOutcome}'s own "replicate, don't
 * generalize" precedent.
 */
public record AutoSaveRecycleBinApplyOutcome(String property, String before, String after,
