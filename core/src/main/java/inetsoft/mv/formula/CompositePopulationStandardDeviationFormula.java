 ...
 */
public class CompositePopulationStandardDeviationFormula
   extends CompositePopulationVarianceFormula
{
   /**
    * Create a standard deviation formula.
    */
   public CompositePopulationStandardDeviationFormula() {
      super();
   }
    ...
    */
   public CompositePopulationStandardDeviationFormula(int[] cols) {
      super(cols);
   }
