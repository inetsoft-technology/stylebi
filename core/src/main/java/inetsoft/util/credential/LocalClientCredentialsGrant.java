...
public class LocalClientCredentialsGrant extends AbstractLocalCredential
   implements ClientCredentialsGrant
{
   public LocalClientCredentialsGrant() {
      super();
   }
   ...
   public boolean equals(Object obj) {
      ...
      if(!(obj instanceof LocalClientCredentialsGrant)) {
         return false;
      }

      return Tool.equals(((LocalClientCredentialsGrant) obj).clientId, clientId) &&
         Tool.equals(((LocalClientCredentialsGrant) obj).clientSecret, clientSecret) &&
         Tool.equals(((LocalClientCredentialsGrant) obj).accessToken, accessToken) &&
         Tool.equals(((LocalClientCredentialsGrant) obj).refreshToken, refreshToken);
   }
