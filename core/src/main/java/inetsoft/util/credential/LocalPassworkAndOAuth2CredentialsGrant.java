...
public class LocalPassworkAndOAuth2CredentialsGrant extends LocalOAuth2CredentialsGrant
   implements PassworkAndOAuth2CredentialsGrant
{
   public LocalPassworkAndOAuth2CredentialsGrant() {
      super();
   }
   ...
   public boolean equals(Object obj) {
      ...
      if(!(obj instanceof LocalPassworkAndOAuth2CredentialsGrant)) {
         return false;
      }

      return Tool.equals(((LocalPassworkAndOAuth2CredentialsGrant) obj).user, user) &&
         Tool.equals(((LocalPassworkAndOAuth2CredentialsGrant) obj).password, password);
   }
