...
public class LocalPasswordAndOAuth2WithFlagCredentialsGrant extends LocalPasswordAndOAuth2CredentialsGrant
   implements PasswordAndOAuth2WithFlagCredentialsGrant
{
   public LocalPasswordAndOAuth2WithFlagCredentialsGrant() {
      super();
   }
   ...
   public boolean equals(Object obj) {
      ...
      if(!(obj instanceof LocalPasswordAndOAuth2WithFlagCredentialsGrant)) {
         return false;
      }

      return Tool.equals(((LocalPasswordAndOAuth2WithFlagCredentialsGrant) obj).oauthFlags, oauthFlags);
   }
