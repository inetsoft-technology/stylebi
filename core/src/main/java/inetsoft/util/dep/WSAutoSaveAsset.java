 ...
 * @version 13.4
 */
public class WSAutoSaveAsset extends WorksheetAsset {
   /**
    * AutoSave type XAsset.
    */
   public static final String AUTOSAVEWS = "AUTOSAVEWS";

   /**
    * Constructor.
    */
   public WSAutoSaveAsset() {
      super();
   }
    ...
    * Constructor.
    *
    * @param worksheet the autosave asset entry.
    */
   public WSAutoSaveAsset(AssetEntry worksheet) {
      this();
   }
   ...
   private static final Logger LOG = LoggerFactory.getLogger(WSAutoSaveAsset.class);
}
