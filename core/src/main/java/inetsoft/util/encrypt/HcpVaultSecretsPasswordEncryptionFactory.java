...
import inetsoft.util.PasswordEncryptionFactory;
import inetsoft.util.config.SecretsConfig;

@AutoService(PasswordEncryptionFactory.class)
public class HcpVaultSecretsPasswordEncryptionFactory implements PasswordEncryptionFactory {
   @Override
   ...
   public PasswordEncryption createPasswordEncryption(SecretsConfig secretsConfig) {
      return new HcpVaultSecretsPasswordEncryption(secretsConfig);
   }
}
