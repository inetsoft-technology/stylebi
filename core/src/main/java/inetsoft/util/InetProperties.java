...
/**
 * property files for supporting international .
 */
public class InetProperties extends Hashtable {
   /**
    ...
    * @serial
    */
   protected InetProperties defaults;
   /**
    ...
    */
   public InetProperties(InetProperties defaults) {
    ...
    *               input stream.
    */
   public synchronized void load(InputStream inStream, String encode)
      throws IOException {
      BufferedReader in;
            ...
            if((firstChar != '#') && (firstChar != '!')) {
               while(continueLine(line)) {
                  ...
                  for(startIndex = 0; startIndex < nextLine.length();
                     startIndex++)
                  {
                     if(whiteSpaceChars.indexOf(nextLine.charAt(startIndex)) ==
                        -1)
                     {
                        break;
                     }
    ...
    * <code>store(OutputStream out, String header)</code> method.
    *
    * @param   out      an output stream.
    * @param   header   a description of the property list.
    * @exception  ClassCastException  if this <code>InetProperties</code> object
    ...
    * <code>InetProperties</code> table to the output stream in a format suitable
    * for loading into a <code>InetProperties</code> table using the
    * <code>load</code> method.
    * The stream is written using the ISO 8859-1 character encoding.
    * <p>
    * InetProperties from the defaults table of this <code>InetProperties</code>
    ...
    * <p>
    * Then every entry in this <code>InetProperties</code> table is written out,
    ...
    * @see     java.util.InetProperties#defaults
    */
