...
/**
 * XFloatList, the inner size and array is accessable.
 *
 * @version 9.1
 * @author InetSoft Technology Corp
 */
public final class XFloatList implements Cloneable, Serializable {
   /**
    * Create an instance of <tt>XFloatList</tt>.
    */
   public XFloatList() {
      this(10);
   }
    ...
    */
   public XFloatList(int size) {
      super();
      this.arr = new float[size];
   }

   /**
    * Trim the capacity of this <tt>XFloatList</tt> instance to be the
    * list's current size.
    */
   ...
   /**
    * Increase the capacity of this <tt>XFloatList</tt> instance.
   ...
   /**
    * Return the index of the last occurrence of the specified float in this
    * list.
    * @param element the desired element.
    * @return the index of the last occurrence of the specified float in this
    * list; if the float is not found.
    */
   ...
   /**
    * Clone this object.
    * @return a clone of this <tt>XFloatList</tt> instance.
    */
   @Override
   public Object clone() {
      try {
         XFloatList v = (XFloatList) super.clone();
         v.arr = new float[size];
         System.arraycopy(arr, 0, v.arr, 0, size);
         return v;
      }
      catch(Exception ex) {
         LOG.error("Failed to clone XFloatList", ex);
      }
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(XFloatList.class);
}
