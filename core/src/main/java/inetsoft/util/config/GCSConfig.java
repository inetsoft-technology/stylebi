...
/**
 * {@code GCSConfig} contains the configuration for Google Cloud Storage (GCS).
 */
@InetsoftConfigBean
public class GCSConfig implements Serializable {
   /**
   ...
   public void setBucket(String bucket) {
      Objects.requireNonNull(bucket, "The GCS bucket is required");
      this.bucket = bucket;
   }
