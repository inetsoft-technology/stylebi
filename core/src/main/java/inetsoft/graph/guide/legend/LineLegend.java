...
/**
 * This class is the legend for showing line aesthetics.
 *
 * @version 10.0
...
public class LineLegend extends Legend {
    ...
    */
   public LineLegend(VisualFrame frame, EGraph graph) {
      super(frame, graph);
   }
   ...
   protected LegendItem createLegendItem(Object label, Object value) {
      return new LineLegendItem(label, value, getVisualFrame());
   }
}
