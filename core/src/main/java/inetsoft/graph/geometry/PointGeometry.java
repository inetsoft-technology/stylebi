...
/**
 * A point geomtry captures the information about a point in a coordinate
 * space.
 *
 * @version 10.0
 * @author InetSoft Technology Corp
 */
public class PointGeometry extends ElementGeometry {
   /**
    ...
    */
   public PointGeometry(GraphElement elem, GGraph graph, String var, int tidx,
   ...
   public VisualObject createVisual(Coordinate coord) {
      PointVO vo = new PointVO(this, coord);
      vo.setColIndex(cidx);
