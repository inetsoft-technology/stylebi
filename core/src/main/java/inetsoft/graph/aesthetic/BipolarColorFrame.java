 ...
 */
@TernClass(url = "#cshid=BipolarColorFrame")
public class BipolarColorFrame extends RGBCubeColorFrame {
   /**
    * Create a color frame. The field needs to be set by calling setField.
    */
   public BipolarColorFrame() {
      super(COLORS);
   }
    ...
    */
   @TernConstructor
   public BipolarColorFrame(String field) {
      this();
      setField(field);
   }
