 ...
 */
package inetsoft.graph.mxgraph.model;
...
public class mxCell implements mxICell, Cloneable, Serializable {
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getId()
    */
   public String getId() {
      return id;
   }
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setId(String)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getValue()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setValue(Object)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getGeometry()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setGeometry(inetsoft.graph.mxgraph.model.mxGeometry)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getStyle()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setStyle(String)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#isVertex()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setVertex(boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#isEdge()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setEdge(boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#isConnectable()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setConnectable(boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#isVisible()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setVisible(boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#isCollapsed()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setCollapsed(boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getParent()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setParent(inetsoft.graph.mxgraph.model.mxICell)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getTerminal(boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#setTerminal(inetsoft.graph.mxgraph.model.mxICell, boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getChildCount()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getIndex(inetsoft.graph.mxgraph.model.mxICell)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getChildAt(int)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#insert(inetsoft.graph.mxgraph.model.mxICell)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#insert(inetsoft.graph.mxgraph.model.mxICell, int)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#remove(int)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#remove(inetsoft.graph.mxgraph.model.mxICell)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#removeFromParent()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getEdgeCount()
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getEdgeIndex(inetsoft.graph.mxgraph.model.mxICell)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#getEdgeAt(int)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#insertEdge(inetsoft.graph.mxgraph.model.mxICell, boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#removeEdge(inetsoft.graph.mxgraph.model.mxICell, boolean)
    */
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.model.mxICell#removeFromTerminal(boolean)
    */
   ...
   /**
    * Calculate parent size by using the average of children.
    */
   public void setAutoSize() {
      ...
      for(Object edge : edges) {
         ...
         w += target.getGeometry().getWidth();
         h += target.getGeometry().getHeight();
      }

      getGeometry().setWidth(w / edges.size());
      getGeometry().setHeight(h / edges.size());
   }
