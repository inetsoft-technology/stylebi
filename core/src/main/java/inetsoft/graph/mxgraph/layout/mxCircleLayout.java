...
public class mxCircleLayout extends mxGraphLayout {
   ...
   // this calculates the radius by trying to fit the verices on a circle. since the max
   // is for both width and height, we may need a more precise algorithm to account
   // for how width and height are used on the circle depending on the angle.
   ...
   public void execute(Object parent)
   {
      ...
      try {
         ...
         double r = Math.max(vertexCount * max * sizeFactor / Math.PI, radius);
