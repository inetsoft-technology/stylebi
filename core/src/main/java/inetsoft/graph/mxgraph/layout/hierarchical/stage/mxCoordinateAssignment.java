...
public class mxCoordinateAssignment implements mxHierarchicalLayoutStage {
   ...
   private void minNode(mxGraphHierarchyModel model)
   {
      ...
      for(int i = 0; i <= model.maxRank; i++) {
         mxGraphHierarchyRank rankSet = model.ranks.get(Integer.valueOf(i));
   ...
   {
      mxGraphHierarchyRank rankSet = model.ranks.get(Integer.valueOf(rankValue));
   ...
   {
      mxGraphHierarchyRank rank = model.ranks.get(Integer.valueOf(rankValue));
      double maxY = 0.0;
   ...
   {
      mxGraphHierarchyRank rankSet = model.ranks.get(Integer.valueOf(rank));
   ...
   protected void localEdgeProcessing(mxGraphHierarchyModel model)
   {
      ...
      // both directions.
      for(int i = 0; i < model.ranks.size(); i++) {
         mxGraphHierarchyRank rank = model.ranks.get(Integer.valueOf(i));
