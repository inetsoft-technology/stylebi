...
public class mxCompactTreeLayout extends mxGraphLayout {
   ...
   public int getPrefVertEdgeOff() {
      return prefVertEdgeOff;
   }

   public void setPrefVertEdgeOff(int prefVertEdgeOff) {
      this.prefVertEdgeOff = prefVertEdgeOff;
   }
   ...
   public void setEdgeSpacing(int edgeSpacing) {
   ...
   protected void processNodeOutgoing(TreeNode node)
   {
      ...
      double edgeSpacing = this.edgeSpacing;
      ...
      if(!(edgeSpacing >= 0)) {
         ...
         edgeSpacing = availableWidth / childCount;
         currentXOffset = edgeSpacing / 2.0;
      ...
      for(int j = 0; j < sortedCellsArray.length; j++) {
         ...
         for(int i = 0; i < edges.length; i++) {
            ...
            if(this.horizontal) {
               ...
               y = edgeSpacing == 0 ? parentBounds.getCenterY()
                  : parentBounds.getY() + currentXOffset;
               ...
               x = edgeSpacing == 0 ? parentBounds.getCenterX()
                  :  parentBounds.getX() + currentXOffset;
