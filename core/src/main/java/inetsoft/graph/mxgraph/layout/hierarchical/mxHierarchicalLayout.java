 ...
 */
package inetsoft.graph.mxgraph.layout.hierarchical;

import inetsoft.graph.mxgraph.layout.hierarchical.model.mxGraphHierarchyModel;
import inetsoft.graph.mxgraph.layout.hierarchical.stage.*;
                           ...
                           List<Set<Object>> hierarchyVertices, Set<Object> filledVertexSet)
   {
      ...
      if(vertex != null && allVertices != null) {
         ...
         if(!allVertices.contains(vertex)
            && (filledVertexSet == null || filledVertexSet
            .contains(vertex)))
         {
