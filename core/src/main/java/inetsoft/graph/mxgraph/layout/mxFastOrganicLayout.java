...
public class mxFastOrganicLayout extends mxGraphLayout {
   ...
   /* (non-Javadoc)
    * @see inetsoft.graph.mxgraph.layout.mxIGraphLayout#move(java.lang.Object, double, double)
    */
   ...
   public void execute(Object parent)
   {
      ...
      for(int i = 0; i < vertexArray.length; i++) {
         ...
         indices.put(vertex, Integer.valueOf(i));
      ...
      try {
         ...
         for(int i = 0; i < vertexArray.length; i++) {
            ...
            if(geo != null) {
               ...
               if(minx == null) {
                  minx = Double.valueOf(x);
               }
               else {
                  minx = Double.valueOf(Math.min(minx.doubleValue(), x));
               }

               if(miny == null) {
                  miny = Double.valueOf(y);
               }
               else {
                  miny = Double.valueOf(Math.min(miny.doubleValue(), y));
               }
            }
         }
