...
public class mxVmlCanvas extends mxBasicCanvas {
                            ...
                            Map<String, Object> style)
   {
      ...
      String s = "position:absolute;left:" + x + "px;top:"
         + y + "px;width:" + w
         + "px;height:" + h + "px;";
   ...
   public Element drawLine(List<mxPoint> pts, Map<String, Object> style)
   {
      ...
      if(strokeColor != null && strokeWidth > 0) {
         ...
         elem.setAttribute("filled", "false");
         elem.setAttribute("strokecolor", strokeColor);
         elem.setAttribute("strokeweight", strokeWidth
            + "px");

         String s = "position:absolute;" + "left:" + r.x
            + "px;" + "top:" + r.y + "px;" + "width:"
            + r.width + "px;" + "height:"
            + r.height + "px;";
         elem.setAttribute("style", s);
         ...
         elem.setAttribute("coordorigin",
                           r.x + " " + r.y);
         elem.setAttribute("coordsize", r.width + " "
            + r.height);
      }
