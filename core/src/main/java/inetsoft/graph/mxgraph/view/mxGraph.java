...
public class mxGraph extends mxEventSource {
   ...
   static {
      try {
         mxResources.add("inetsoft.graph.mxgraph.resources.graph");
      }
      catch(Exception e) {
         log.log(Level.INFO, "Failed to add the resource bundle", e);
      }
   }
    ...
    * {@link inetsoft.graph.mxgraph.model.mxGraphModel}.
    */
   public mxGraph()
   {
      this(null, null);
    ...
    * specified, then a new, empty {@link inetsoft.graph.mxgraph.model.mxGraphModel} is
    * used.
    *
      ...
      if(vertex != null && constraint.point != null) {
         ...
         if(constraint.perimeter) {
            ...
            if(this.getModel().isVertex(vertex.cell)) {
               boolean flipH = mxUtils.getInt(vertex.getStyle(), mxConstants.STYLE_FLIPH) == 1;
               boolean flipV = mxUtils.getInt(vertex.getStyle(), mxConstants.STYLE_FLIPV) == 1;
   ...
   public boolean isLabelClipped(Object cell)
   {
      if(!isLabelsClipped()) {
         ...
         return style != null && mxUtils.getString(style, mxConstants.STYLE_OVERFLOW, "")
            .equals("hidden");
      }
