...
public class mxEdgeStyle {
   ...
   public static mxEdgeStyleFunction EntityRelation = new mxEdgeStyleFunction() {
      ...
      /* (non-Javadoc)
       * @see inetsoft.graph.mxgraph.view.mxEdgeStyle.mxEdgeStyleFunction#apply(inetsoft.graph.mxgraph.view.mxCellState, inetsoft.graph.mxgraph.view.mxCellState, inetsoft.graph.mxgraph.view.mxCellState, java.util.List, java.util.List)
       */
