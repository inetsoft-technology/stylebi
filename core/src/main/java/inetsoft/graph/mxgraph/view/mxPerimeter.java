...
public class mxPerimeter {
   ...
   public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction() {
      ...
      /* (non-Javadoc)
       * @see inetsoft.graph.mxgraph.view.mxPerimeter.mxPerimeterFunction#apply
       */
   ...
   public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction() {
      ...
      /* (non-Javadoc)
       * @see inetsoft.graph.mxgraph.view.mxPerimeter.mxPerimeterFunction#apply(inetsoft.graph.mxgraph.utils.mxRectangle, inetsoft.graph.mxgraph.view.mxCellState, inetsoft.graph.mxgraph.view.mxCellState, boolean, inetsoft.graph.mxgraph.utils.mxPoint)
       */
      public mxPoint apply(mxRectangle bounds, mxCellState vertex,
                           mxPoint next, boolean orthogonal)
      {
