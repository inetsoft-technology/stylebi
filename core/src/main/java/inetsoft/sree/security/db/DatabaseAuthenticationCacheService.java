...
public class DatabaseAuthenticationCacheService implements Service {
   public DatabaseAuthenticationCacheService(String providerName) {
   ...
   private static final Logger LOG =
      LoggerFactory.getLogger(DatabaseAuthenticationCacheService.class);
