...
@AutoService(BinarySerializerFactory.class)
public class Object2ObjectOpenHashMapSerializerFactory implements BinarySerializerFactory {
   @Override
   ...
   public static final class Serializer implements BinarySerializer {
      @Override
