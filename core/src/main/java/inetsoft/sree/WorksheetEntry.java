 ...
 * @version 11.4
 */
public class WorksheetEntry extends RepositoryEntry {
   /**
    * Constructor.
    */
    ...
    */
   public WorksheetEntry(String path, IdentityID owner) {
      super(path, RepositoryEntry.WORKSHEET, owner);
   }
    ...
    * @param alias the specified worksheet.
    */
    ...
    * @return the alias of the worksheet.
    */
