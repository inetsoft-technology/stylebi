 ...
 */
public class Barcode2of7Presenter extends AbstractBarcodePresenter {
   /**
   ...
   protected Barcode createBarcode(String str) {
      try {
         return BarcodeFactory.create2of7(str);
      }
   ...
   public String getDisplayName() {
      return Catalog.getCatalog().getString("Barcode 2 of 7");
   }

   private static final Logger LOG =
      LoggerFactory.getLogger(Barcode2of7Presenter.class);
}
