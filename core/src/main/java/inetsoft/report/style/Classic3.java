...
/**
 * The Classic3 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Classic3 is:<p>
 * <img src="images/Classic3.gif"><p>
 ...
 */
public class Classic3 extends TableStyle {
   /**
    ...
    */
   public Classic3(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         if(r == -1 || r == lastRow() || isTrailerRowFormat(r + 1)) {
            return MEDIUM_LINE;
         }
