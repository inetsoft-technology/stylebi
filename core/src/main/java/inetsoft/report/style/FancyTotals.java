...
/**
 * The FancyTotals class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for FancyTotals is:<p>
 * <img src="images/FancyTotals.gif"><p>
 ...
 */
public class FancyTotals extends TableStyle {
   /**
    ...
    */
   public FancyTotals(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (isTrailerRowFormat(r + 1) && !isTrailerRowFormat(r)) ?
            DOUBLE_LINE :
            NO_BORDER;
      }
      ...
      public int getColBorder(int r, int c) {
         return (isTrailerColFormat(c + 1) && !isTrailerColFormat(c)) ?
            THIN_LINE :
            NO_BORDER;
      }
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ? new Color(0, 180, 120) : null;
      }
   }
}
