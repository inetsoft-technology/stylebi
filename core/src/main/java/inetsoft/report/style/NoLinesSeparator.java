...
/**
 * The NoLinesSeparator class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for NoLinesSeparator is:<p>
 * <img src="images/NoLinesSeparator.gif"><p>
 ...
 */
public class NoLinesSeparator extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public NoLinesSeparator() {
   }
    ...
    */
   public NoLinesSeparator(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return isHeaderColFormat(c) && !isHeaderColFormat(c + 1) ?
            MEDIUM_LINE :
            NO_BORDER;
      }
