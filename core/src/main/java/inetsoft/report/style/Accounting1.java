...
/**
 * The Accounting1 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Accounting1 is:<p>
 * <img src="images/Accounting1.gif"><p>
 ...
 */
public class Accounting1 extends TableStyle {
   /**
    ...
    */
   public Accounting1(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (isHeaderRowFormat(r) && !isHeaderRowFormat(r + 1) ||
            ...
            THIN_LINE :
            ((r == lastRow()) ? DOUBLE_LINE : NO_BORDER);
      }
