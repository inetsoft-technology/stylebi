...
/**
 * The Effect3D2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Effect3D2 is:<p>
 * <img src="images/Effect3D2.gif"><p>
 ...
 */
public class Effect3D2 extends TableStyle {
   /**
    ...
    */
   public Effect3D2(TableLens table) {
      super(table);
   }
