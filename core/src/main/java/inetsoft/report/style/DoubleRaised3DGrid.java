...
/**
 * The DoubleRaised3DGrid class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for DoubleRaised3DGrid is:<p>
 * <img src="images/DoubleRaised3DGrid.gif"><p>
 ...
 */
public class DoubleRaised3DGrid extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public DoubleRaised3DGrid() {
   }
    ...
    */
   public DoubleRaised3DGrid(TableLens table) {
      super(table);
   }
