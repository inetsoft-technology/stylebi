...
/**
 * The List5 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List5 is:<p>
 * <img src="images/List5.gif"><p>
 ...
 */
public class List5 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return isHeaderRowFormat(r) ? MEDIUM_LINE : THIN_LINE;
      }
