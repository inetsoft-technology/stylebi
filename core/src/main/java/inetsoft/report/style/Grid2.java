...
/**
 * The Grid2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Grid2 is:<p>
 * <img src="images/Grid2.gif"><p>
