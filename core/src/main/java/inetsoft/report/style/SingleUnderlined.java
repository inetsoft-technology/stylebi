...
/**
 * The SingleUnderlined class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for SingleUnderlined is:<p>
 * <img src="images/SingleUnderlined.gif"><p>
 ...
 */
public class SingleUnderlined extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public SingleUnderlined() {
   }
    ...
    */
   public SingleUnderlined(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r >= 0) ? THIN_LINE : NO_BORDER;
      }
