...
/**
 * The FancyJustify class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for FancyJustify is:<p>
 * <img src="images/FancyJustify.gif"><p>
 ...
 */
public class FancyJustify extends TableStyle {
   /**
    ...
    */
   public FancyJustify(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || isHeaderColFormat(c) && !isHeaderColFormat(c + 1)) ?
            THIN_LINE :
            (c == lastCol() ||
