...
/**
 * The List6 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List6 is:<p>
 * <img src="images/List6.gif"><p>
 ...
 */
public class List6 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return isHeaderColFormat(c) ?
            MEDIUM_LINE :
            ((c == -1 || c == lastCol()) ? THIN_LINE : NO_BORDER);
      }
      ...
      public Color getBackground(int r, int c) {
         return (r % 2 == 0) ? Color.lightGray : null;
      }
   }
}
