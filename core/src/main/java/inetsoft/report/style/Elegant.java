...
/**
 * The Elegant class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Elegant is:<p>
 * <img src="images/Elegant.gif"><p>
 ...
 */
public class Elegant extends TableStyle {
   /**
    ...
    */
   public Elegant(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == -1 || r == lastRow()) ? DOUBLE_LINE : THIN_LINE;
      }
      ...
      public Font getFont(int r, int c) {
         ...
         int line = (font instanceof StyleFont) ?
         ...
         return isHeaderRowFormat(r) ?
            new StyleFont(font.getName(), StyleFont.ALLCAPS | font.getStyle(),
            font.getSize(), line) :
            font;
      }
   }
