...
/**
 * The ColumnFillTotals class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for ColumnFillTotals is:<p>
 * <img src="images/ColumnFillTotals.gif"><p>
 ...
 */
public class ColumnFillTotals extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public ColumnFillTotals() {
   }
    ...
    */
   public ColumnFillTotals(TableLens table) {
      super(table);
   }
