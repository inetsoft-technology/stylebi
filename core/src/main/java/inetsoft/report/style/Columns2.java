...
/**
 * The Columns2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Columns2 is:<p>
 * <img src="images/Columns2.gif"><p>
 ...
 */
public class Columns2 extends TableStyle {
   /**
    ...
    */
   public Columns2(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         if(isHeaderColFormat(c) && r < lastRow()) {
            bold = !bold;
         }
      ...
      public Color getBackground(int r, int c) {
         ...
         return (c % 2 == 1) ? new Color(128, 255, 128) : Color.white;
      }
   }
}
