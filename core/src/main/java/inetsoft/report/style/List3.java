...
/**
 * The List3 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List3 is:<p>
 * <img src="images/List3.gif"><p>
 ...
 */
public class List3 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public Color getForeground(int r, int c) {
         if(isHeaderRowFormat(r) ||
            isTrailerRowFormat(r) && isHeaderColFormat(c)) {
            return Color.blue;
         }
