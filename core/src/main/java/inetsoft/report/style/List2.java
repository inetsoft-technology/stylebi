...
/**
 * The List2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List2 is:<p>
 * <img src="images/List2.gif"><p>
 ...
 */
public class List2 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         ...
         return (r == lastRow()) ? MEDIUM_LINE : NO_BORDER;
      }
