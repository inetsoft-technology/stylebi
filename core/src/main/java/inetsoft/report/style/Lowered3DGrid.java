...
/**
 * The Lowered3DGrid class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Lowered3DGrid is:<p>
 * <img src="images/Lowered3DGrid.gif"><p>
 ...
 */
public class Lowered3DGrid extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public Lowered3DGrid() {
   }
    ...
    */
   public Lowered3DGrid(TableLens table) {
      super(table);
   }
