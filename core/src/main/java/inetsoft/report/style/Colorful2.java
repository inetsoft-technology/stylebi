...
/**
 * The Colorful2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Colorful2 is:<p>
 * <img src="images/Colorful2.gif"><p>
 ...
 */
public class Colorful2 extends TableStyle {
   /**
    ...
    */
   public Colorful2(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         if(isTrailerRowFormat(r) || isHeaderRowFormat(r)) {
            return MEDIUM_LINE;
         }
