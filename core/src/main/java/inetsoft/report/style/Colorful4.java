...
/**
 * The Colorful4 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Colorful4 is:<p>
 * <img src="images/Colorful4.gif"><p>
 ...
 */
public class Colorful4 extends TableStyle {
   /**
    ...
    */
   public Colorful4(TableLens table) {
      super(table);
   }
