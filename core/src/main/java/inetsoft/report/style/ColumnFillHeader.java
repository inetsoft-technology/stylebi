...
/**
 * The ColumnFillHeader class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for ColumnFillHeader is:<p>
 * <img src="images/ColumnFillHeader.gif"><p>
 ...
 */
public class ColumnFillHeader extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public ColumnFillHeader() {
   }
    ...
    */
   public ColumnFillHeader(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         if(r == -1 || r == lastRow() || isHeaderRowFormat(r)) {
            return THIN_LINE;
         }
      ...
      public Color getBackground(int r, int c) {
         return (c % 2 == 0) ? new Color(200, 200, 200) : null;
      }
   }
}
