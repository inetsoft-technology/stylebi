...
/**
 * The Columns4 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Columns4 is:<p>
 * <img src="images/Columns4.gif"><p>
 ...
 */
public class Columns4 extends TableStyle {
   /**
    ...
    */
   public Columns4(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         if(isTrailerRowFormat(r) || isTrailerColFormat(c)) {
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ?
            Color.black :
            ((c % 2 == 0) ? new Color(100, 172, 172) : Color.white);
      }
   }
}
