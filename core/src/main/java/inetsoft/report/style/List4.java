...
/**
 * The List4 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List4 is:<p>
 * <img src="images/List4.gif"><p>
 ...
 */
public class List4 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || c == lastCol()) ? MEDIUM_LINE : NO_BORDER;
      }
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ? Color.gray : Color.white;
      }
   }
}
