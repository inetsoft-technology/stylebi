...
/**
 * The Accounting3 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Accounting3 is:<p>
 * <img src="images/Accounting3.gif"><p>
...
public class Accounting3 extends TableStyle {
    ...
    */
   public Accounting3(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Color getRowBorderColor(int r, int c) {
         return isHeaderRowFormat(r) ? new Color(0, 64, 128) : 
      ...
      public Font getFont(int r, int c) {
         ...
         return (isHeaderRowFormat(r) && isTrailerColFormat(c)) ?
            createFont(font, Font.BOLD | Font.ITALIC) :
            ((isHeaderRowFormat(r) && !isTrailerColFormat(c) ||
            isHeaderColFormat(c) && !isTrailerRowFormat(r)) ?
