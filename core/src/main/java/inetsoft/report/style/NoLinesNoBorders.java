...
/**
 * The NoLinesNoBorders class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for NoLinesNoBorders is:<p>
 * <img src="images/NoLinesNoBorders.gif"><p>
 ...
 */
public class NoLinesNoBorders extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public NoLinesNoBorders() {
   }
    ...
    */
   public NoLinesNoBorders(TableLens table) {
      super(table);
   }
