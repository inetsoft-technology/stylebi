...
/**
 * The NoLinesTotals class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for NoLinesTotals is:<p>
 * <img src="images/NoLinesTotals.gif"><p>
 ...
 */
public class NoLinesTotals extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public NoLinesTotals() {
   }
    ...
    */
   public NoLinesTotals(TableLens table) {
      super(table);
   }
