...
/**
 * The HeaderFillColumn class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for HeaderFillColumn is:<p>
 * <img src="images/HeaderFillColumn.gif"><p>
...
public class HeaderFillColumn extends TableStyle {
    ...
    */
   public HeaderFillColumn(TableLens table) {
      super(table);
   }
