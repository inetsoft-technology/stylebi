...
/**
 * The NoLinesSingle class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for NoLinesSingle is:<p>
 * <img src="images/NoLinesSingle.gif"><p>
 ...
 */
public class NoLinesSingle extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public NoLinesSingle() {
   }
    ...
    */
   public NoLinesSingle(TableLens table) {
      super(table);
   }
