...
/**
 * The Colorful1 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Colorful1 is:<p>
 * <img src="images/Colorful1.gif"><p>
...
public class Colorful1 extends TableStyle {
    ...
    */
   public Colorful1(TableLens table) {
      super(table);
   }
