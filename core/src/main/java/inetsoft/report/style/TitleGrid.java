...
/**
 * The TitleGrid class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for TitleGrid is:<p>
 * <img src="images/TitleGrid.gif"><p>
 ...
 */
public class TitleGrid extends TableStyle {
   /**
    ...
    */
   public TitleGrid(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r >= getHeaderRowCount() - 1 && c >= getHeaderColCount()) ?
            THIN_LINE :
            NONE;
      }
      ...
      public int getColBorder(int r, int c) {
         return (c >= getHeaderColCount() - 1 && r >= getHeaderRowCount()) ?
            THIN_LINE :
            NONE;
      }
