...
/**
 * The SingleDoubleBorder class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for SingleDoubleBorder is:<p>
 * <img src="images/SingleDoubleBorder.gif"><p>
 ...
 */
public class SingleDoubleBorder extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public SingleDoubleBorder() {
   }
    ...
    */
   public SingleDoubleBorder(TableLens table) {
      super(table);
   }
