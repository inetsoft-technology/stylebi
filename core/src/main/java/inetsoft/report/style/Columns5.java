...
/**
 * The Columns5 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Columns5 is:<p>
 * <img src="images/Columns5.gif"><p>
 ...
 */
public class Columns5 extends TableStyle {
   /**
    ...
    */
   public Columns5(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         else if(isHeaderColFormat(c) || isTrailerColFormat(c) ||
