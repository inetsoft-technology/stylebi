...
/**
 * The LedgerHeader class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for LedgerHeader is:<p>
 * <img src="images/LedgerHeader.gif"><p>
 ...
 */
public class LedgerHeader extends TableStyle {
   /**
    ...
    */
   public LedgerHeader(TableLens table) {
      super(table);
   }
