...
/**
 * The List1 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List1 is:<p>
 * <img src="images/List1.gif"><p>
 ...
 */
public class List1 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         if(isHeaderRowFormat(r)) {
            return createFont(font, Font.BOLD | Font.ITALIC);
         }
         else if(isTrailerRowFormat(r) && c == 0) {
      ...
      public Color getForeground(int r, int c) {
         return isHeaderRowFormat(r) ? new Color(128, 64, 64) : null;
      }
   }
}
