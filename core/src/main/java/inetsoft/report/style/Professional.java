...
/**
 * The Professional class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Professional is:<p>
 * <img src="images/Professional.gif"><p>
 ...
 */
public class Professional extends TableStyle {
   /**
    ...
    */
   public Professional(TableLens table) {
      super(table);
   }
