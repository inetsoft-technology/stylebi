...
/**
 * The FancyLabels class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for FancyLabels is:<p>
 * <img src="images/FancyLabels.gif"><p>
 ...
 */
public class FancyLabels extends TableStyle {
   /**
    ...
    */
   public FancyLabels(TableLens table) {
      super(table);
   }
