...
/**
 * The List7 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List7 is:<p>
 * <img src="images/List7.gif"><p>
 ...
 */
public class List7 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public Color getBackground(int r, int c) {
         return (r > 0 && r % 2 == 0) ? new Color(255, 255, 128) : null;
      }
   }
}
