...
/**
 * The NoLinesHeader class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for NoLinesHeader is:<p>
 * <img src="images/NoLinesHeader.gif"><p>
 ...
 */
public class NoLinesHeader extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public NoLinesHeader() {
   }
    ...
    */
   public NoLinesHeader(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || c == lastCol() || isHeaderRowFormat(r)) ?
            THIN_LINE :
            NO_BORDER;
      }
