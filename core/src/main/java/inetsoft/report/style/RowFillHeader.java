...
/**
 * The RowFillHeader class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for RowFillHeader is:<p>
 * <img src="images/RowFillHeader.gif"><p>
...
public class RowFillHeader extends TableStyle {
    ...
    */
   public RowFillHeader(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || c == lastCol()) ?
            DOUBLE_LINE :
            (isHeaderRowFormat(r) ? NO_BORDER : THIN_LINE);
      }
