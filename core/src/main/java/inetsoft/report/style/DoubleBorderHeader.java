...
/**
 * The DoubleBorderHeader class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for DoubleBorderHeader is:<p>
 * <img src="images/DoubleBorderHeader.gif"><p>
 ...
 */
public class DoubleBorderHeader extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public DoubleBorderHeader() {
   }
    ...
    */
   public DoubleBorderHeader(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == -1 || r == lastRow() || isHeaderRowFormat(r)) ?
            DOUBLE_LINE :
            THIN_LINE;
      }
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || c == lastCol()) ? DOUBLE_LINE : THIN_LINE;
      }
