...
/**
 * The FancyHeader class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for FancyHeader is:<p>
 * <img src="images/FancyHeader.gif"><p>
 ...
 */
public class FancyHeader extends TableStyle {
   /**
    ...
    */
   public FancyHeader(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (isHeaderRowFormat(r) && !isHeaderRowFormat(r + 1) ||
            ...
            MEDIUM_LINE :
            ((r == -1 || r == lastRow()) ? THIN_LINE : NO_BORDER);
      }
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || c == lastCol()) ? THIN_LINE : NO_BORDER;
      }
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ? new Color(100, 172, 172) : null;
      }
   }
}
