...
/**
 * The NoLinesColumns class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for NoLinesColumns is:<p>
 * <img src="images/NoLinesColumns.gif"><p>
 ...
 */
public class NoLinesColumns extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public NoLinesColumns() {
   }
    ...
    */
   public NoLinesColumns(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == -1 || r == lastRow() ||
            isHeaderRowFormat(r) && !isHeaderRowFormat(r + 1)) ?
            THIN_LINE :
            NO_BORDER;
      }
