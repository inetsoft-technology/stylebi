...
/**
 * The Accounting2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Accounting2 is:<p>
 * <img src="images/Accounting2.gif"><p>
 ...
 */
public class Accounting2 extends TableStyle {
   /**
    ...
    */
   public Accounting2(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (isHeaderRowFormat(r) && !isHeaderRowFormat(r + 1) ||
            !isTrailerRowFormat(r) && isTrailerRowFormat(r + 1)) ?
            THIN_LINE :
      ...
      public int getAlignment(int r, int c) {
         return (c == 0) ? (H_LEFT | V_CENTER) : (H_RIGHT | V_CENTER);
      }
   }
}
