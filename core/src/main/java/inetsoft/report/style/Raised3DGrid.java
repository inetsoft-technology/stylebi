...
/**
 * The Raised3DGrid class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Raised3DGrid is:<p>
 * <img src="images/Raised3DGrid.gif"><p>
 ...
 */
public class Raised3DGrid extends TableStyle {
   /**
    ...
    */
   public Raised3DGrid(TableLens table) {
      super(table);
   }
