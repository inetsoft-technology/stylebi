...
/**
 * The Contemporary1 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Contemporary1 is:<p>
 * <img src="images/Contemporary1.gif"><p>
 ...
 */
public class Contemporary1 extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public Contemporary1() {
   }
    ...
    */
   public Contemporary1(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Color getBackground(int r, int c) {
         return (r % 2 == 1) ? null : new Color(200, 200, 200);
      }
   }
}
