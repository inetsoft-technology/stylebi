...
/**
 * The RowFillColumns class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for RowFillColumns is:<p>
 * <img src="images/RowFillColumns.gif"><p>
 ...
 */
public class RowFillColumns extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public RowFillColumns() {
   }
    ...
    */
   public RowFillColumns(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == -1 || r == lastRow()) ? THIN_LINE : NO_BORDER;
      }
      ...
      public Color getBackground(int r, int c) {
         return (r % 2 == 0) ? new Color(220, 220, 220) : null;
      }
   }
}
