...
/**
 * The Columns1 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Columns1 is:<p>
 * <img src="images/Columns1.gif"><p>
 ...
 */
public class Columns1 extends TableStyle {
   /**
    ...
    */
   public Columns1(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c > 0 || c < lastCol()) ? NO_BORDER : MEDIUM_LINE;
      }
      ...
      public Font getFont(int r, int c) {
         ...
         if(isTrailerColFormat(c)) {
            bold = !bold;
         }

         return createFont(font, bold ? Font.BOLD : Font.PLAIN);
      }
      ...
      public Color getBackground(int r, int c) {
         return (c % 2 == 1) ? new Color(255, 255, 128) : null;
      }
   }
}
