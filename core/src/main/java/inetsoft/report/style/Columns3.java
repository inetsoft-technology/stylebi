...
/**
 * The Columns3 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Columns3 is:<p>
 * <img src="images/Columns3.gif"><p>
 ...
 */
public class Columns3 extends TableStyle {
   /**
    ...
    */
   public Columns3(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ?
            Color.blue :
            ((c % 2 == 0) ? Color.lightGray : Color.white);
      }
   }
}
