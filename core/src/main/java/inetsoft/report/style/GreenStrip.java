...
/**
 * The GreenStrip class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for GreenStrip is:<p>
 * <img src="images/GreenStrip.gif"><p>
...
public class GreenStrip extends TableStyle {
    ...
    */
   public GreenStrip(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Color getBackground(int r, int c) {
         return (r % 2 == 0) ? new Color(120, 230, 120) : null;
      }
   }
}
