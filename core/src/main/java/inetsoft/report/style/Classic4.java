...
/**
 * The Classic4 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Classic4 is:<p>
 * <img src="images/Classic4.gif"><p>
 ...
 */
public class Classic4 extends TableStyle {
   /**
    ...
    */
   public Classic4(TableLens table) {
      super(table);
   }
