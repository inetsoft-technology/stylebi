...
/**
 * The DoubleLineGrid class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for DoubleLineGrid is:<p>
 * <img src="images/DoubleLineGrid.gif"><p>
 ...
 */
public class DoubleLineGrid extends TableStyle {
   /**
    ...
    */
   public DoubleLineGrid(TableLens table) {
      super(table);
   }
