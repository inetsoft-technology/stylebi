...
/**
 * The FancyOpen class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for FancyOpen is:<p>
 * <img src="images/FancyOpen.gif"><p>
 ...
 */
public class FancyOpen extends TableStyle {
   /**
    ...
    */
   public FancyOpen(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (isHeaderRowFormat(r) || isTrailerRowFormat(r)) ?
            THIN_LINE :
            ((r == -1 || r == lastRow()) ? MEDIUM_LINE : NO_BORDER);
      }
      ...
      public int getColBorder(int r, int c) {
         return (isHeaderRowFormat(r) || isTrailerRowFormat(r)) ?
            ((c == -1 || c == lastCol()) ? THIN_LINE : MEDIUM_LINE) :
            NO_BORDER;
      }
      ...
      public Font getFont(int r, int c) {
         ...
         return isHeaderRowFormat(r) ?
            ...
            (isHeaderColFormat(c) ? createFont(font, Font.BOLD) : font);
      }
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ?
            new Color(100, 172, 172) :
            isTrailerRowFormat(r) ? new Color(192, 192, 192) : null;
      }
   }
}
