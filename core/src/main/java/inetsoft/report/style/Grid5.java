...
/**
 * The Grid5 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Grid5 is:<p>
 * <img src="images/Grid5.gif"><p>
 ...
 */
public class Grid5 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         if(r < 0 || r >= lastRow() || isHeaderRowFormat(r)) {
            return MEDIUM_LINE;
         }
      ...
      public int getColBorder(int r, int c) {
         return (c < 0 || c >= lastCol()) ? MEDIUM_LINE : THIN_LINE;
      }
