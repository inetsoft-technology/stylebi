...
/**
 * The SingleNoBorder class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for SingleNoBorder is:<p>
 * <img src="images/SingleNoBorder.gif"><p>
 ...
 */
public class SingleNoBorder extends TableStyle {
   /**
    * Create an empty style. The setTable() method must be called before
    * it can be used.
    */
   public SingleNoBorder() {
   }
    ...
    */
   public SingleNoBorder(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         if(isHeaderRowFormat(r)) {
            return createFont(font, Font.ITALIC);
         }
         else if(isTrailerRowFormat(r)) {
            return createFont(font, Font.BOLD);
         }
         else if(isHeaderColFormat(c)) {
            return createFont(font, Font.ITALIC);
         }
         else if(isTrailerColFormat(c)) {
            return createFont(font, Font.BOLD);
         }
