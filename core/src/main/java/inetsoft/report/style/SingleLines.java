...
/**
 * The SingleLines class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for SingleLines is:<p>
 * <img src="images/SingleLines.gif"><p>
 ...
 */
public class SingleLines extends TableStyle {
   /**
    ...
    */
   public SingleLines(TableLens table) {
      super(table);
   }
