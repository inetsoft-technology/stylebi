...
/**
 * The Grid8 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Grid8 is:<p>
 * <img src="images/Grid8.gif"><p>
 ...
 */
public class Grid8 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         if(isHeaderRowFormat(r) || isTrailerRowFormat(r) ||
      ...
      public Color getForeground(int r, int c) {
         return isHeaderRowFormat(r) ? Color.white : null;
      }
      ...
      public Color getBackground(int r, int c) {
         return isHeaderRowFormat(r) ? Color.blue : null;
      }
   }
}
