...
/**
 * The List8 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for List8 is:<p>
 * <img src="images/List8.gif"><p>
 ...
 */
public class List8 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public Font getFont(int r, int c) {
         ...
         else if(isTrailerRowFormat(r) || isHeaderColFormat(c) ||
      ...
      public Color getBackground(int r, int c) {
         return isHeaderColFormat(c) ?
            new Color(255, 255, 0) :
            ((r % 2 == 0) ? new Color(255, 128, 128) : null);
      }
   }
}
