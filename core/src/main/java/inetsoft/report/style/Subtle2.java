...
/**
 * The Subtle2 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Subtle2 is:<p>
 * <img src="images/Subtle2.gif"><p>
 ...
 */
public class Subtle2 extends TableStyle {
   /**
    ...
    */
   public Subtle2(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Color getBackground(int r, int c) {
         return ((isHeaderColFormat(c) || isTrailerColFormat(c)) &&
            !isHeaderRowFormat(r)) ?
            new Color(200, 255, 175) :
            null;
      }
   }
}
