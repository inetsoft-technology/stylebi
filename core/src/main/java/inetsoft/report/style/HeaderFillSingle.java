...
/**
 * The HeaderFillSingle class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for HeaderFillSingle is:<p>
 * <img src="images/HeaderFillSingle.gif"><p>
...
public class HeaderFillSingle extends TableStyle {
    ...
    */
   public HeaderFillSingle(TableLens table) {
      super(table);
   }
