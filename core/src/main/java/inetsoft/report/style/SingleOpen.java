...
/**
 * The SingleOpen class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for SingleOpen is:<p>
 * <img src="images/SingleOpen.gif"><p>
 ...
 */
public class SingleOpen extends TableStyle {
   /**
    ...
    */
   public SingleOpen(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c >= 0 && c < lastCol() && !isHeaderRowFormat(r)) ?
            THIN_LINE :
            NO_BORDER;
      }
