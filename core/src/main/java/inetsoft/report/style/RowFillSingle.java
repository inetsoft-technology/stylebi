...
/**
 * The RowFillSingle class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for RowFillSingle is:<p>
 * <img src="images/RowFillSingle.gif"><p>
...
public class RowFillSingle extends TableStyle {
    ...
    */
   public RowFillSingle(TableLens table) {
      super(table);
   }
