...
/**
 * The Grid6 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Grid6 is:<p>
 * <img src="images/Grid6.gif"><p>
 ...
 */
public class Grid6 extends TableStyle {
   /**
   ...
   class Style extends Transparent {
      ...
      public int getColBorder(int r, int c) {
         return (c == -1 || c == lastCol()) ? MEDIUM_LINE : THIN_LINE;
      }
