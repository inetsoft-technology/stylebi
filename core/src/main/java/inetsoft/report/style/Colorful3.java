...
/**
 * The Colorful3 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Colorful3 is:<p>
 * <img src="images/Colorful3.gif"><p>
 ...
 */
public class Colorful3 extends TableStyle {
   /**
    ...
    */
   public Colorful3(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public Color getRowBorderColor(int r, int c) {
         if(r == -1 || isTrailerRowFormat(r) || isHeaderRowFormat(r) || 
            r == lastRow()) 
         {
      ...
      public Font getFont(int r, int c) {
         ...
         return createFont(font, Font.PLAIN);
      }
