...
/**
 * The Simple4 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Simple4 is:<p>
 * <img src="images/Simple4.gif"><p>
 ...
 */
public class Simple4 extends TableStyle {
   /**
    ...
    */
   public Simple4(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == 0 || r == lastRow() - 1) ?
            THIN_LINE :
            ((r < 0 || r >= lastRow()) ? MEDIUM_LINE : NO_BORDER);
      }
