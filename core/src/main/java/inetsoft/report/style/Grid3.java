...
/**
 * The Grid3 class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for Grid3 is:<p>
 * <img src="images/Grid3.gif"><p>
 ...
 */
public class Grid3 extends TableStyle {
   /**
