...
/**
 * The ColumnFillColor class is a table style class. It can be used with other
 * table lens classes to provide a visual style for table formatting and
 * printing. The default style for ColumnFillColor is:<p>
 * <img src="images/ColumnFillColor.gif"><p>
...
public class ColumnFillColor extends TableStyle {
    ...
    */
   public ColumnFillColor(TableLens table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == -1) ?
            ...
            DOUBLE_LINE :
            (isHeaderRowFormat(r) ? MEDIUM_LINE : NO_BORDER));
      }
      ...
      public Color getBackground(int r, int c) {
         return (!isHeaderRowFormat(r) && c % 2 == 0) ?
            new Color(200, 200, 200) :
            (!isHeaderRowFormat(r) ? new Color(255, 255, 128) : null);
      }
   }
}
