 ...
 * @since  7.0
 */
public abstract class GeneratorFactory implements ExportFactory {
   /**
   ...
   public final Object createExporter(OutputStream output, Object data) {
      return createGenerator(output, data);
   }
    ...
    */
   protected abstract Generator createGenerator(OutputStream output,
                                                Object data);
}
