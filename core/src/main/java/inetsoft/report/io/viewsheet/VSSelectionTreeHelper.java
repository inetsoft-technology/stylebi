...
public class VSSelectionTreeHelper extends VSSelectionListHelper {
   ...
   protected void prepareDisplayList(SelectionTreeVSAssemblyInfo info,
                                     ...
                                     boolean displayAll, boolean expandAll, String[] expandedPaths)
   {
      ...
      info.visitCompositeChild(csv, dispList, true, expandAll, expandedPaths);  // populate dispList
   ...
   protected void writeTitle(SelectionTreeVSAssemblyInfo info) {
      ...
      VSCompositeFormat format = VSTitleChromeDefaults.applyModernDefaults(finfo.getFormat(new TableDataPath(-1, TableDataPath.TITLE), false));
