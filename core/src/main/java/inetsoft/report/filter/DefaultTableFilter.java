...
/**
 * Default table filter provide default implementations for all the methods
 * defined in table filter. Please set base table before calling table filter
 * methods.
 *
 * @version 6.1
 * @author InetSoft Technology Corp
 */
public class DefaultTableFilter extends AbstractTableLens
   implements DataTableLens, TableFilter
{
   /**
    ...
    */
   public DefaultTableFilter(TableLens table) {
      setTable(table);
   }
