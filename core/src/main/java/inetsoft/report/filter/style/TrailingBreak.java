...
/**
 * Trailing break style.
 *
 * @version 5.1, 9/20/2003
 * @author InetSoft Technology Corp
 */
public class TrailingBreak extends GroupStyle {
   /**
    ...
    */
   public TrailingBreak(GroupedTable table) {
      super(table);
   }
   ...
   class Style extends Transparent {
      ...
      public int getRowBorder(int r, int c) {
         return (r == -1 || r == lastRow()) ?
            ...
            gtable.isGroupHeaderRow(r) && gtable.getObject(r, 0) != null ||
            gtable.isGroupHeaderRow(r + 1) &&
            gtable.getObject(r + 1, c) != null || gtable.isSummaryRow(r + 1)) ?
            DASH_LINE :
            NO_BORDER));
      }
