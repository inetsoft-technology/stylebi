...
**Companion drawings:** `Chart overlay surfaces - decided visuals.dc.html` — §01 selection, §03 the Resize
...
See **`Chart overlay surfaces - decided visuals.dc.html`** §03 — current versus proposed over a mock plot,
...
which shrinks everything after it, then apply the drawing in `Chart overlay surfaces - decided visuals.dc.html` §03.
