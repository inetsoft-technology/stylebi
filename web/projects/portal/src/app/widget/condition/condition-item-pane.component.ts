...
@Component({
    ...
    imports: [ConditionFieldComboComponent, FormsModule, OneOfConditionEditor, BinaryConditionEditor, ConditionEditor, FormulaEditorDialog, ConditionOperationPipe, CustomSelectComponent]
})
