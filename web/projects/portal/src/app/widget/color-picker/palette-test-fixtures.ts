...
// first pair is pinned against drift, by cssMatchesTheJavaFallback, which covers all 40 slots.
// Move all four together when the head is re-tuned. The modern tail is deliberately not here:
// palette40 pads with LEGACY_TAIL because the specs that use it assert on length and identity
// rather than on which colours come back.
