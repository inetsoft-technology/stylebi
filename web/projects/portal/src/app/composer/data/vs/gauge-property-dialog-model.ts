 ...
 */
import { GaugeGeneralPaneModel } from "./gauge-general-pane-model";
import { DataOutputPaneModel } from "./data-output-pane-model";
import { GaugeAdvancedPaneModel } from "./gauge-advanced-pane-model";
import { VSAssemblyScriptPaneModel } from "../../../widget/dialog/vsassembly-script-pane/vsassembly-script-pane-model";

export interface GaugePropertyDialogModel {
