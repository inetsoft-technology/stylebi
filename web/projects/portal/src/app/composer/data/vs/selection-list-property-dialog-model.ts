...
import { SelectionGeneralPaneModel } from "./selection-general-pane-model";
import { SelectionListPaneModel } from "./selection-list-pane-model";

export interface SelectionListPropertyDialogModel {
