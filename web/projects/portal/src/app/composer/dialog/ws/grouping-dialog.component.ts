...
@Component({
    ...
    imports: [ModalHeaderComponent, EnterSubmitDirective, FormsModule, ReactiveFormsModule, InputTrimDirective, TreeDropdownComponent, LargeFormFieldComponent, GroupingConditionDialog, ConditionPipe, JunctionOperatorPipe, CustomSelectComponent]
})
