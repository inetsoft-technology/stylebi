...
@Component({
    ...
    imports: [ModalHeaderComponent, EnterSubmitDirective, FormsModule, ReactiveFormsModule, InputTrimDirective, TabularViewComponent, ApplyButtonComponent, CustomSelectComponent]
})
