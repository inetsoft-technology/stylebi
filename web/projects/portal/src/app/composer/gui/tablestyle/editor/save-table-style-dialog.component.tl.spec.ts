 ...
 *
 * Fixed bugs:
 *   Bug #75598 — ok() subscribe leak: http.get().subscribe() stored no Subscription reference; if
...
describe("SaveTableStyleDialog — ok()", () => {
   ...
   // Regression test for Bug #75598: ok() called http.get().subscribe() without storing the
