 ...
 */
import { TableViewGeneralPaneModel } from "./table-view-general-pane-model";
import { CrosstabAdvancedPaneModel } from "./crosstab-advanced-pane-model";
...
export interface CrosstabPropertyDialogModel {
