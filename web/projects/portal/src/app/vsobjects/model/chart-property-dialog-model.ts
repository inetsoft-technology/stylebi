 ...
 */
import { ChartGeneralPaneModel } from "./chart-general-pane-model";
...
import { HierarchyPropertyPaneModel } from "./hierarchy-property-pane-model";
import { ChartLinePaneModel } from "./chart-line-pane-model";

export interface ChartPropertyDialogModel {
   chartGeneralPaneModel: ChartGeneralPaneModel;
   chartAdvancedPaneModel: ChartAdvancedPaneModel;
