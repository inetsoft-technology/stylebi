...
describe("VSGauge", () => {
   ...
   beforeEach(() => {
      ...
      contextProvider = {};
      viewDataService = {};
      dataTipService = { isDataTip: vi.fn(), isCurrentDataTip: vi.fn(), isDataTipVisible: vi.fn(), getVSObjectId: vi.fn(), isFrozen: vi.fn(), hideDataTip: vi.fn(), dataTipName: null, dataTipY: 0, dataTipX: 0, dataTipAlpha: 1, viewerOffset: {width: 0, height: 0}, scrolled: new Subject<void>() };
