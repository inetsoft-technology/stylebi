...
export class GroupContainerActions extends AbstractVSActions<VSGroupContainerModel> {
   constructor(model: VSGroupContainerModel, contextProvider: ContextProvider,
