...
export class RadioButtonActions extends AbstractVSActions<VSRadioButtonModel> {
   constructor(model: VSRadioButtonModel, contextProvider: ContextProvider,
   ...
   protected createMenuActions(groups: AssemblyActionGroup[]): AssemblyActionGroup[] {
      groups.push(new AssemblyActionGroup([
         ...
         {
            id: () => "radio-button show-format-pane",
            label: () => "_#(js:Format)...",
            icon: () => "fa fa-format",
            enabled: () => true,
            visible: () => this.composer
   ...
   protected getEditScriptActionId(): string {
      return "radio-button edit-script";
   }
}
