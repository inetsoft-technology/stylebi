...
export class ViewsheetActions extends AbstractVSActions<VSViewsheetModel> {
   constructor(model: VSViewsheetModel, contextProvider: ContextProvider,
