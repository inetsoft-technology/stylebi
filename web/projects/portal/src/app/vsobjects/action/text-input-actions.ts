...
export class TextInputActions extends AbstractVSActions<VSTextInputModel> {
   constructor(model: VSTextInputModel, contextProvider: ContextProvider,
   ...
   protected createMenuActions(groups: AssemblyActionGroup[]): AssemblyActionGroup[] {
      groups.push(new AssemblyActionGroup([
         {
            id: () => "text-input properties",
            label: () => "_#(js:Properties)...",
            icon: () => "fa fa-text-inputs",
            enabled: () => true,
            visible: () => this.composer
         },
         {
            id: () => "text-input show-format-pane",
            label: () => "_#(js:Format)...",
            icon: () => "fa fa-format",
            enabled: () => true,
            visible: () => this.composer
