...
describe("LineActions", () => {
   ...
   xit("check status of menu actions of line in composer", () => {
      const expectedMenu = [
         [
            ...
            { id: "line show-format-pane", visible: true },
            { id: "line lock", visible: true },
            { id: "line unlock", visible: false }
         ],
         [
      ...
      const actions = new LineActions(model, ComposerContextProviderFactory());
   ...
   xit("check status of menu actions of line in viewer and preview", () => {
      const expectedMenu = [
         [
            ...
            { id: "line show-format-pane", visible: false },
            { id: "line lock", visible: false },
            { id: "line unlock", visible: false }
         ],
         [
            { id: "rectangle annotate", visible: false }
      ...
      const model = createModel();
      const actions1 = new LineActions(model, ViewerContextProviderFactory(false));
      ...
      const actions2 = new LineActions(model2, ViewerContextProviderFactory(true));
   ...
   it("should not display menu action when as data tip component", () => {
      ...
      const model = createModel();
      const actions = new LineActions(model, ViewerContextProviderFactory(false), false, null, dataTipService);
      const menuActions = actions.menuActions;
