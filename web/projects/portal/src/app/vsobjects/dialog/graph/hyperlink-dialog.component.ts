...
@Component({
    ...
    imports: [ModalHeaderComponent, EnterSubmitDirective, FormsModule, ExpressionEditor, FixedDropdownDirective, NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, RepositoryTreeComponent, LargeFormFieldComponent, GenericSelectableList, ApplyButtonComponent, InputParameterDialog, CustomSelectComponent]
})
