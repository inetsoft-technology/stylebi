...
@Component({
    ...
    imports: [FormsModule, DynamicComboBox, FixedDropdownDirective, SelectionListDialog, VariableListDialog, CdkVirtualScrollViewport, CdkFixedSizeVirtualScroll, CdkVirtualForOf, CustomSelectComponent]
})
