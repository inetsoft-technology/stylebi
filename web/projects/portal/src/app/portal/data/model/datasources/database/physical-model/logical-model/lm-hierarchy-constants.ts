 ...
 */
export class LMHierarchyConstants {
   /**
    * the dimension type of logical model hierarchy columns.
    */
   public static DIMENSION = 0;
   /**
    ...
    */
   public static MEASURE = 2;

   /**
    * the year level of date cube member.
    */
   public static YEAR_LEVEL = "Year";

   /**
    * the quarter level of date cube member.
    */
   public static QUARTER_LEVEL = "Quarter";

   /**
    * the month level of date cube member.
    */
   public static MONTH_LEVEL = "Month";

   /**
    * the day level of date cube member.
    */
   public static DAY_LEVEL = "Day";
}
