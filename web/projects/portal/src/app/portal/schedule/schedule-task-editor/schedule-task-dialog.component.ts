...
@Component({
    ...
    standalone: true,
    imports: [ModalHeaderComponent, NgIf, EnterSubmitDirective, FormsModule, ReactiveFormsModule, NgbNav, NgbNavItem, NgbNavLink, NgbNavLinkBase, NgbNavContent, TaskConditionPane, TaskActionPane, TaskOptionsPane, NgbNavOutlet, NotificationsComponent]
})
