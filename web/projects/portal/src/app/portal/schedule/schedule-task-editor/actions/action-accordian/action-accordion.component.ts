...
@Component({
    ...
    imports: [FormsModule, ReactiveFormsModule, GenericSelectableList, NgbTypeahead, CSVConfigPane, CkeditorWrapperComponent, ParameterTable, EmailAddrDialog, NgbHighlight, CustomSelectComponent]
})
