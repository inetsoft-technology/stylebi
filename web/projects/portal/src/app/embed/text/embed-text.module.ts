...
import { EmbedTextRoutingModule } from "./app-routing.module";
...
@NgModule({
   ...
   declarations: [EmbedTextComponent],
   providers: [
      DataTipService,
      PopComponentService,
      MiniToolbarService,
   ...
   bootstrap: [EmbedTextComponent]
})
export class EmbedTextModule {
   constructor(public injector: Injector) {
      const embedText = createCustomElement(EmbedTextComponent,
         {injector});
      customElements.define("inetsoft-text", embedText);
   }
}
