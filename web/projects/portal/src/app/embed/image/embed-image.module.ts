...
import { EmbedImageRoutingModule } from "./app-routing.module";
...
@NgModule({
   ...
   bootstrap: [EmbedImageComponent]
})
export class EmbedImageModule {
   constructor(public injector: Injector) {
      const embedImage = createCustomElement(EmbedImageComponent,
         {injector});
      customElements.define("inetsoft-image", embedImage);
   }
}
