...
export function EMBED_IMAGE_URL_MATCHER(url: UrlSegment[]): UrlMatchResult {
...
const routes: Routes = [
   {
      component: EmbedImageComponent,
      canDeactivate: [canDeactivateGuard],
      matcher: EMBED_IMAGE_URL_MATCHER
   }
];
...
export class EmbedImageRoutingModule {
}
