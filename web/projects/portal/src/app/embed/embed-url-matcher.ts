...
/**
 * Creates a URL matcher for embed component routes.
 *
 * This matcher handles the following URL patterns:
 * - runtime/<runtimeId>/<assemblyName> - for existing viewsheet instances
 * - global/<path>/<assemblyName> - for global scope viewsheets
 * - user/<owner>/<path>/<assemblyName> - for user scope viewsheets
 * - <assetId>/<assemblyName> - for raw asset IDs (e.g., "1^128^__NULL__^path")
 */
export function createEmbedUrlMatcher(url: UrlSegment[]): UrlMatchResult {
