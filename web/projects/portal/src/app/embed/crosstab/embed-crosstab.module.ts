...
import { EmbedCrosstabRoutingModule } from "./app-routing.module";
...
@NgModule({
   ...
   declarations: [EmbedCrosstabComponent],
   providers: [
      DataTipService,
      PopComponentService,
      MiniToolbarService,
   ...
   bootstrap: [EmbedCrosstabComponent]
})
export class EmbedCrosstabModule {
   constructor(public injector: Injector) {
      const embedCrosstab = createCustomElement(EmbedCrosstabComponent,
         {injector});
      customElements.define("inetsoft-crosstab", embedCrosstab);
   }
}
