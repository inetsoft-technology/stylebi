...
export class UpdateColumnsEvent implements ViewsheetEvent {
   constructor(private transfer?: number, private dropTarget?: number, private objectType?: VSObjectType) {
   }
}
