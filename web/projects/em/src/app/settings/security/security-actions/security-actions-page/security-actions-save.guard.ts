...
export const securityActionsSaveGuard: CanDeactivateFn<SecurityActionsPageComponent> = (component: SecurityActionsPageComponent, currentRoute: ActivatedRouteSnapshot, currentState: RouterStateSnapshot, nextState: RouterStateSnapshot): Observable<boolean> => {
