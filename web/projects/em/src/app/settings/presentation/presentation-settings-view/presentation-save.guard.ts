...
export const presentationSaveGuard: CanDeactivateFn<PresentationSettingsViewComponent> = (component: PresentationSettingsViewComponent, currentRoute: ActivatedRouteSnapshot, currentState: RouterStateSnapshot, nextState: RouterStateSnapshot): Observable<boolean> => {
