...
export const generalSaveGuard: CanDeactivateFn<GeneralSettingsPageComponent> = (component: GeneralSettingsPageComponent, currentRoute: ActivatedRouteSnapshot, currentState: RouterStateSnapshot, nextState: RouterStateSnapshot): Observable<boolean> => {
