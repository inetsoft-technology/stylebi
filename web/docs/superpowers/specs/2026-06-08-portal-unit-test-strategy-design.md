...
来源：`docs/superpowers/prompts/risk-driven-test-generation.md` Stage 1
...
- 测试生成 prompt：`docs/superpowers/prompts/risk-driven-test-generation.md`
- 补充技术说明：`docs/superpowers/prompts/test-techniques-reference.md`
- em 项目参考 PR：`https://github.com/inetsoft-technology/stylebi/pull/3858`
- MSW 服务端：`mocks/server.ts`
- Portal vitest 配置：`projects/portal/src/vitest-setup-tl.ts`