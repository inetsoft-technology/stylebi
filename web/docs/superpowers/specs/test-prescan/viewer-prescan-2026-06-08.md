...
**测试进度**: ✅已测试 44 / 142 | 待测 66 / 142 | ⏭ 已跳过 21 / 142 | ⏸️暂缓 11 / 142
...
| ⏸️暂缓/s | VSCheckBox | 80 | 1 | 0 | **single-pass** | 暂缓 | ⚠️ vs-check-box.spec.ts | Only tests CSS H/V alignment rendering; isSelected, onChange toggle branches (deselect/select, refresh/non-refresh, ctrlDown), and applySelection debounce/fallback are entirely untested. | P1: vs-check-box.interaction.tl.spec.ts |
