...
|------|------|-------------|----------|-------------|------|------|---------|-------------|-----------|
| 待审核 | EmbedChartComponent | 368 | 1 | 9 | **multi-pass** | ✅ 推进 |  |  | P1: EmbedChartComponent.interaction.tl.spec.ts<br>P2: EmbedChartComponent.risk.tl.spec.ts |
...
**Pass 1** (`EmbedChartComponent.interaction.tl.spec.ts`)
...
**Pass 2** (`EmbedChartComponent.risk.tl.spec.ts`)
...
**Pass 1** (`VSChart.interaction.tl.spec.ts`)
...
**Pass 2** (`VSChart.risk.tl.spec.ts`)
...
**Pass 1** (`MiniToolbar.interaction.tl.spec.ts`)
...
**Pass 2** (`MiniToolbar.risk.tl.spec.ts`)
