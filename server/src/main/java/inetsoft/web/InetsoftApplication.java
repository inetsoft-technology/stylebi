...
public class InetsoftApplication {
   public static void main(String[] args) {
      ...
      configure(home);
      SpringApplication.run(InetsoftApplication.class, args);
    ...
    */
   private static boolean isScheduleCluster() {
    ...
    */
   private static boolean isSchedulerServerAutoStart() {
   ...
   private static void configure(String home) {
