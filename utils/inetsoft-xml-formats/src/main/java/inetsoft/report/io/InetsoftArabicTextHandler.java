 ...
 * <p>
 * Contains a fix for batik ArabicTextHandler, https://issues.apache.org/jira/browse/BATIK-1074.
 * Modified doubleCharRemappings to include the missing entries.
 */
public final class InetsoftArabicTextHandler {
    ...
    */
   private InetsoftArabicTextHandler() {
         ...
         if(charStartsLigature(c) && (i + 1 < end)) {
            ...
            if(form != null && nextForm != null) {
                  ...
                  && nextForm.equals(ARABIC_INITIAL))
               {
                  ...
                  int substChar = InetsoftArabicTextHandler.getSubstituteChar
